...
<CourseInfo teacher="~~巫芳璟~~ 林忠緯" credits={3} grade="A+" sweet="3/5" cool="2/5" gain="5/5" />
...
<CourseInfo teacher="洪一平" credits={3} grade="A+" sweet="3/5" cool="4/5" gain="0/5" />
...
<CourseInfo teacher="陳尚澤/陳縕儂" credits={3} grade="A+" sweet="3/5" cool="2/5" gain="3/5" />

一門從傳統 AI 講到 GenAI 的課程，上半學期是陳尚澤老師，上的內容是傳統 AI，基本上就是照搬 UC Berkeley 的 [CS188](https://www.youtube.com/@berkeley-cs188)：
...
上半學期我基本都沒去上課都是補 CS188 的影片~~我覺得原版講的比較清楚~~，我完全沒有去上課過，根據去現場的同學的說法，是不如回家看影片
...
一個學期總共四次 Assignments，每次都是有 Programming 跟 Writing，前兩次的 programming 就是把 CS188 的東西搬過來寫，Writing 部分則是很像一些小謎題，都很簡單，或是 trace 一些 algorithm; 後半的話則是要 train model 然後比較他們，一次是用 Linear Model, 另一次是 NN，要寫實驗報告，通靈只佔很小一部分，基本上是去網路上找教學寫，Writing 的話就是經典 ML 題目，一堆線代加上一堆機率，算是簡單的證明題，也挺好寫的

上到 4/8 隔一週就是期中考，期中考題目很多，總共八面，很多很難算的東西，比如說 RL 的 Policy Iteration, Value Iteration，總之花時間挺長，但難度不難 ~~我在這裡第一個 100 分~~

最後 Final Proejct 我覺得蠻有趣的，是要自己想方法去打 [6 Nimmt!](https://zh.wikipedia.org/zh-tw/%E8%B0%81%E6%98%AF%E7%89%9B%E5%A4%B4%E7%8E%8B) 不像是一般的 AI 課瘋狂通靈、調參，你要自己想要用什麼 model 或 method 去寫兩個 agent，我自己的 agent 一個是用 MCTS，另一個是 RL，但我怎麼調 RL 都打不贏 MCTS。這次有一個 midterm submission 的機制，要你先教一份 code 上去給助教們測，算在總分裡面，算是一種防止你到最後才寫的機制，總之我覺得是一個蠻有趣的 final project，~~最後 grading 的時候助教好像發現自己的 baseline 不小心寫的太強了，還緊急調分，超好笑~~

### 專題研究

<CourseInfo teacher="林智仁" credits={2} grade="A+" sweet="2/5" cool="2/5" gain="3000" />
...
<ImageGrid
  cols={3}
  images={[
    { src: '/images/ntu-csie-sophomore-2/prof-lin-writing-1.webp', caption: '超絕藝術字體 1' },
    { src: '/images/ntu-csie-sophomore-2/prof-lin-writing-2.webp', caption: '超絕藝術字體 2' },
    { src: '/images/ntu-csie-sophomore-2/prof-lin-writing-3.webp', caption: '超絕影印 Slide' }
  ]}
/>
...
<CourseInfo teacher="林智仁" credits={3} grade="A+" sweet="3/5" cool="2/5" gain="4/5" />
...
<CourseInfo teacher="鄭文皇" credits={3} sweet="3/5" cool="3/5" gain="0/5（我的問題）" />
...
<details class="note-box">
<summary>關於 Final Project</summary>
...
<CourseInfo teacher="陳彥賓" credits={3} grade="A+" sweet="5/5" cool="5/5" gain="1/5" />
...
<CourseInfo teacher="許恒達/陳彥賓" credits={2} grade="A+" sweet="10/5" cool="10/5" gain="2/5（收穫美編能力）" />
...
<CourseInfo teacher="林家振" credits={3} grade="A+" sweet="10/5" cool="10/5" gain="2/5" />
...
<CourseInfo teacher="陳君鳳" credits={1} grade="A+" sweet="3/5" cool="4/5" gain="4/5" />
...
<CourseInfo teacher="蔡國榮" credits={2} />

因為是農院、心理系的班群，所以這學期就只有半學期的課，心得總之是跟上半學期差不多，還是愛國榮，國榮還讓我們下學期繼續當他的助教，愛國榮

### 資料結構與演算法

<CourseInfo teacher="林軒田/蔡欣穆" credits={3} />
