...
description: "NTU System Programming 系統程式設計:Ch6 Process Control & IPC"
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/bootstrapping.webp" style="width: 100%;" />
  <br />
...
- Process states:
    ...
    - Terminated
- <div style="text-align: center;">
    <img loading="lazy" decoding="async" src="/images/sp/ch06-process/process-control-block-1.webp" style="width: 100%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/process-control-block-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
### Context switch
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/context-switch-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Context switch 1
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/context-switch-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Context switch 2
  </span>
...
- <div style="text-align: center;">
    <img loading="lazy" decoding="async" src="/images/sp/ch06-process/process-content-and-metadata.webp" style="width: 100%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
       Process Content &amp; Metadata
    </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/process-creation-and-termination-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Process Creation &amp; Termination 1
  </span>
</div>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/process-creation-and-termination-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Process Creation &amp; Termination 2
  </span>
</div>
</Aside>
...
- 把 virtual memory map 到 physical memory 上
    ...
    - <div style="text-align: center;">
        <img loading="lazy" decoding="async" src="/images/sp/ch06-process/process-creation-and-termination-3.webp" style="width: 100%;" />
        <br />
        <span style="color: grey; font-size: 16px;">
           Process Creation &amp; Termination 3
        </span>
      </div>
- **Copy-on-write**
    - <div style="text-align: center;">
        <img loading="lazy" decoding="async" src="/images/sp/ch06-process/process-creation-and-termination-4.webp" style="width: 100%;" />
        <br />
        <span style="color: grey; font-size: 16px;">
           Process Creation &amp; Termination 4
        </span>
      </div>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/normal-cases-in-fork.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Normal cases in fork
  </span>
...
- **Normal termination**
    - <div style="text-align: center;">
        <img loading="lazy" decoding="async" src="/images/sp/ch06-process/process-termination-1.webp" style="width: 100%;" />
        <br />
        <span style="color: grey; font-size: 16px;">
...
可以透過一系列 macro 去獲得死亡訊息
 <div style="text-align: center;">
   <img loading="lazy" decoding="async" src="/images/sp/ch06-process/process-termination-2.webp" style="width: 100%;" />
   <br />
   <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/orphan.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Orphan
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/race-condition-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Race Condition 1
  </span>
...
- **`int main(int agrc, char **argv, char **envp);`**
    ...
    - 通常會被放在 stack 的上層
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/race-condition-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Race Condition 2
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/race-condition-3.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Race Condition 3
  </span>
...
<Aside type="note" title="">
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/race-condition-4.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Race Condition 4
  </span>
...
**Close on exec**
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/race-condition-5.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Race Condition 5
  </span>
...
- 一端寫一端讀，不一定多少人
- <div style="text-align: center;">
    <img loading="lazy" decoding="async" src="/images/sp/ch06-process/pipe-1.webp" style="width: 100%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
       Pipe 1
    </span>
...
- <div style="text-align: center;">
    <img loading="lazy" decoding="async" src="/images/sp/ch06-process/pipe-2.webp" style="width: 100%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
       Pipe 2
    </span>
...
- <div style="text-align: center;">
    <img loading="lazy" decoding="async" src="/images/sp/ch06-process/pipe-3.webp" style="width: 100%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
       Pipe 3
    </span>
...
```
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/pipe-4.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Pipe 4
  </span>
...
<Aside type="tip" title="Example">
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/fifo-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     FIFO 1
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/fifo-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     FIFO 2
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch06-process/fifo-3.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     FIFO 3
  </span>
