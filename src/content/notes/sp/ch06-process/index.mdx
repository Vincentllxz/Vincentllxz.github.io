...
- **`PID 2`**: `pagedaemon`
![截圖 2025-10-16 上午9.32.39](/images/hackmd/B1USspT6lg.png)
...
- Process states:
    ...
    - Ready
    - Terminated
- ![截圖 2025-10-16 上午9.40.01](/images/hackmd/BJoeTpa6lg.png)
...
![截圖 2025-10-16 上午9.44.27](/images/hackmd/SJL-RaTTlx.png)
...
### Context switch
![截圖 2025-10-16 上午9.53.12](/images/hackmd/Sy4zxAT6ex.png)
...
![截圖 2025-10-16 上午10.00.45](/images/hackmd/HyCJGA6pel.png)
</Aside>


### Process Content & Metadata
- **Content**: Virtual memory 
- ![截圖 2025-10-16 上午9.55.36](/images/hackmd/rkNjeCpalg.png)
- text: instruction
...
![截圖 2025-10-16 上午10.00.02](/images/hackmd/ry2iZCTTle.png)
...
![截圖 2025-10-16 上午10.04.28](/images/hackmd/Syd2fRTTel.png)
</Aside>
...
- 把 virtual memory map 到 physical memory 上
    ...
    - ![截圖 2025-10-16 上午10.13.23](/images/hackmd/SyJR4Apalx.png)
- **Copy-on-write**
    - ![截圖 2025-10-16 上午10.13.35](/images/hackmd/Hk5R4C6aeg.png)
...
![截圖 2025-10-16 上午10.51.20](/images/hackmd/rkzpTCapxe.png)
...
### Process Termination
- **Normal termination**
    - ![截圖 2025-10-16 上午11.11.33](/images/hackmd/rJMuMJCpeg.png)
...
可以透過一系列 macro 去獲得死亡訊息
 ![截圖 2025-10-18 下午3.04.40](/images/hackmd/S1EGnhx0ll.png)
...
![截圖 2025-10-26 下午4.06.58](/images/hackmd/By6jI8i0xg.png)
...
![截圖 2025-10-26 下午4.46.45](/images/hackmd/rJb-gviAlg.png)
</Aside>
...
- **`int main(int agrc, char **argv, char **envp);`**
    ...
    - 通常會被放在 stack 的上層
![截圖 2025-10-26 晚上7.38.50](/images/hackmd/SkD8_tiRex.png)

![截圖 2025-10-26 晚上7.26.35](/images/hackmd/HyhuBFsRlg.png)
</Aside>
...
<Aside type="note" title="">
![截圖 2025-10-26 晚上7.48.31](/images/hackmd/rJi5cKiRgl.png)
同常只有 `execve` 是 system call 其他都可以根據這張圖，用 function call 外包
</Aside>

**Close on exec**
![截圖 2025-10-26 晚上7.53.58](/images/hackmd/ryWy3toRxg.png)
- 要不要再執行後把 element 關掉
...
- 一端寫一端讀，不一定多少人
- ![截圖 2025-10-16 上午11.55.07](/images/hackmd/By8o3kCagx.png)
- `fork()` 時如何送資訊給別人
...
- ![截圖 2025-10-16 上午11.55.50](/images/hackmd/S1fR21R6lg.png)
- ![截圖 2025-10-16 上午11.57.24](/images/hackmd/ryJ4akApxg.png)
- `$ ls | more`
...
```
![截圖 2025-10-26 晚上8.34.33](/images/hackmd/SkVPB9jCee.png)
...
<Aside type="tip" title="Example">
![截圖 2025-10-26 晚上9.06.54](/images/hackmd/Sy9ep9sRex.png)
- 把東西同時送給兩個地方
</Aside>
 
<Aside type="tip" title="Socket">
![截圖 2025-10-26 晚上9.13.08](/images/hackmd/Hy0vAcsAee.png)
- 可以讓大家都寫在裡面，server 可以讀
- pipe 無法單端讀寫，因此 response 需要這樣送，如下圖
    - client 的會是 specific 的，不然會混淆
![截圖 2025-10-26 晚上9.17.26](/images/hackmd/SJ-uJjo0gx.png)
