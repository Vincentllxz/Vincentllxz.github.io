...
- **`PID 2`**: `pagedaemon`
![Bootstrapping](/images/sp/ch06-process/bootstrapping.png)
...
- Process states:
    ...
    - Ready
    - Terminated
- ![Process Control Block 1](/images/sp/ch06-process/process-control-block-1.png)
...
![Process Control Block 2](/images/sp/ch06-process/process-control-block-2.png)
...
### Context switch
![Context switch 1](/images/sp/ch06-process/context-switch-1.png)
...
![Context switch 2](/images/sp/ch06-process/context-switch-2.png)
</Aside>


### Process Content & Metadata
- **Content**: Virtual memory 
- ![Process Content & Metadata](/images/sp/ch06-process/process-content-and-metadata.png)
- text: instruction
...
![Process Creation & Termination 1](/images/sp/ch06-process/process-creation-and-termination-1.png)
...
![Process Creation & Termination 2](/images/sp/ch06-process/process-creation-and-termination-2.png)
</Aside>
...
- 把 virtual memory map 到 physical memory 上
    ...
    - ![Process Creation & Termination 3](/images/sp/ch06-process/process-creation-and-termination-3.png)
- **Copy-on-write**
    - ![Process Creation & Termination 4](/images/sp/ch06-process/process-creation-and-termination-4.png)
...
![Normal cases in fork](/images/sp/ch06-process/normal-cases-in-fork.png)
...
### Process Termination
- **Normal termination**
    - ![Process Termination 1](/images/sp/ch06-process/process-termination-1.png)
...
可以透過一系列 macro 去獲得死亡訊息
 ![Process Termination 2](/images/sp/ch06-process/process-termination-2.png)
...
![Orphan](/images/sp/ch06-process/orphan.png)
...
![Race Condition 1](/images/sp/ch06-process/race-condition-1.png)
</Aside>
...
- **`int main(int agrc, char **argv, char **envp);`**
    ...
    - 通常會被放在 stack 的上層
![Race Condition 2](/images/sp/ch06-process/race-condition-2.png)

![Race Condition 3](/images/sp/ch06-process/race-condition-3.png)
</Aside>
...
<Aside type="note" title="">
![Race Condition 4](/images/sp/ch06-process/race-condition-4.png)
同常只有 `execve` 是 system call 其他都可以根據這張圖，用 function call 外包
</Aside>

**Close on exec**
![Race Condition 5](/images/sp/ch06-process/race-condition-5.png)
- 要不要再執行後把 element 關掉
...
- 一端寫一端讀，不一定多少人
- ![Pipe 1](/images/sp/ch06-process/pipe-1.png)
- `fork()` 時如何送資訊給別人
...
- ![Pipe 2](/images/sp/ch06-process/pipe-2.png)
- ![Pipe 3](/images/sp/ch06-process/pipe-3.png)
- `$ ls | more`
...
```
![Pipe 4](/images/sp/ch06-process/pipe-4.png)
...
<Aside type="tip" title="Example">
![FIFO 1](/images/sp/ch06-process/fifo-1.png)
- 把東西同時送給兩個地方
</Aside>
 
<Aside type="tip" title="Socket">
![FIFO 2](/images/sp/ch06-process/fifo-2.png)
- 可以讓大家都寫在裡面，server 可以讀
- pipe 無法單端讀寫，因此 response 需要這樣送，如下圖
    - client 的會是 specific 的，不然會混淆
![FIFO 3](/images/sp/ch06-process/fifo-3.png)
