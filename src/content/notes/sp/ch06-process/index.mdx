...
- **`PID 2`**: `pagedaemon`
<Fig src="/images/sp/ch06-process/bootstrapping.webp" caption="Bootstrapping" />
...
- Process states:
    ...
    - Ready
    - Terminated
- <Fig src="/images/sp/ch06-process/process-control-block-1.webp" caption="Process Control Block 1" />
...
<Fig src="/images/sp/ch06-process/process-control-block-2.webp" caption="Process Control Block 2" />
...
### Context switch
<Fig src="/images/sp/ch06-process/context-switch-1.webp" caption="Context switch 1" />
...
<Fig src="/images/sp/ch06-process/context-switch-2.webp" caption="Context switch 2" />
</Aside>


### Process Content & Metadata
- **Content**: Virtual memory 
- <Fig src="/images/sp/ch06-process/process-content-and-metadata.webp" caption="Process Content &amp; Metadata" />
- text: instruction
...
<Fig src="/images/sp/ch06-process/process-creation-and-termination-1.webp" caption="Process Creation &amp; Termination 1" />
...
<Fig src="/images/sp/ch06-process/process-creation-and-termination-2.webp" caption="Process Creation &amp; Termination 2" />
</Aside>
...
- 把 virtual memory map 到 physical memory 上
    ...
    - <Fig src="/images/sp/ch06-process/process-creation-and-termination-3.webp" caption="Process Creation &amp; Termination 3" />
- **Copy-on-write**
    - <Fig src="/images/sp/ch06-process/process-creation-and-termination-4.webp" caption="Process Creation &amp; Termination 4" />
...
<Fig src="/images/sp/ch06-process/normal-cases-in-fork.webp" caption="Normal cases in fork" />
...
### Process Termination
- **Normal termination**
    - <Fig src="/images/sp/ch06-process/process-termination-1.webp" caption="Process Termination 1" />
...
可以透過一系列 macro 去獲得死亡訊息
 <Fig src="/images/sp/ch06-process/process-termination-2.webp" caption="Process Termination 2" />
...
<Fig src="/images/sp/ch06-process/orphan.webp" caption="Orphan" />
...
<Fig src="/images/sp/ch06-process/race-condition-1.webp" caption="Race Condition 1" />
</Aside>
...
- **`int main(int agrc, char **argv, char **envp);`**
    ...
    - 通常會被放在 stack 的上層
<Fig src="/images/sp/ch06-process/race-condition-2.webp" caption="Race Condition 2" />

<Fig src="/images/sp/ch06-process/race-condition-3.webp" caption="Race Condition 3" />
</Aside>
...
<Aside type="note" title="">
<Fig src="/images/sp/ch06-process/race-condition-4.webp" caption="Race Condition 4" />
同常只有 `execve` 是 system call 其他都可以根據這張圖，用 function call 外包
</Aside>

**Close on exec**
<Fig src="/images/sp/ch06-process/race-condition-5.webp" caption="Race Condition 5" />
- 要不要再執行後把 element 關掉
...
- 一端寫一端讀，不一定多少人
- <Fig src="/images/sp/ch06-process/pipe-1.webp" caption="Pipe 1" />
- `fork()` 時如何送資訊給別人
...
- <Fig src="/images/sp/ch06-process/pipe-2.webp" caption="Pipe 2" />
- <Fig src="/images/sp/ch06-process/pipe-3.webp" caption="Pipe 3" />
- `$ ls | more`
...
```
<Fig src="/images/sp/ch06-process/pipe-4.webp" caption="Pipe 4" />
...
<Aside type="tip" title="Example">
<Fig src="/images/sp/ch06-process/fifo-1.webp" caption="FIFO 1" />
- 把東西同時送給兩個地方
</Aside>
 
<Aside type="tip" title="Socket">
<Fig src="/images/sp/ch06-process/fifo-2.webp" caption="FIFO 2" />
- 可以讓大家都寫在裡面，server 可以讀
- pipe 無法單端讀寫，因此 response 需要這樣送，如下圖
    - client 的會是 specific 的，不然會混淆
<Fig src="/images/sp/ch06-process/fifo-3.webp" caption="FIFO 3" />
