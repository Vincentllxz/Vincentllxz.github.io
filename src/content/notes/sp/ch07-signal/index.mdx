...
![截圖 2025-11-06 上午10.40.06](/images/hackmd/B1Z9ctF1Zg.png)
...
![截圖 2025-11-06 上午10.43.53](/images/hackmd/BkE_oKYybe.png)
...
### Reentrant Function
<Aside type="tip" title="Example">
![截圖 2025-11-06 上午11.03.48](/images/hackmd/BJy7g5K1bl.png)
</Aside>
...
![截圖 2025-11-06 上午11.21.48](/images/hackmd/ryjO45KJ-x.png)
...
### Reliable Signals
- 紀錄時間，把它分成兩個 phase 
![截圖 2025-11-06 上午11.53.04](/images/hackmd/HyoojqY1-l.png)
...
![截圖 2025-11-13 上午10.16.39](/images/hackmd/ryQcypfl-x.png)
...
### Idea: 必定由深層到淺層跳
![截圖 2025-11-13 上午10.22.48](/images/hackmd/By7-Wpzx-x.png)
- 這個 code 可以 call 因為他的 stack 順序是正確的

![截圖 2025-11-13 上午10.23.36](/images/hackmd/H1X4bTfl-l.png)
- 壓掉 `P2` 後還繼續跳 `P2` 不行
</Aside>

<Aside type="note" title="Co-routine">
- 雖然理論上不能從淺層往深層 jump，但實務上我們會用這個方法做 co-routine
![截圖 2025-11-17 下午3.42.30](/images/hackmd/r1GZfLdeWx.png)
- 紅色代表當前的 `top`
...
![截圖 2025-11-13 上午10.43.35](/images/hackmd/SyfJ8TGebg.png)
...
![截圖 2025-11-13 上午11.30.05](/images/hackmd/HkFpgRfg-e.png)
...
![截圖 2025-11-20 上午9.37.03](/images/hackmd/ryRTllnlWg.png)
1. 開始時 mask 為 empty
...
### IPC with signal
**Wrong case**
![截圖 2025-11-20 上午10.20.16](/images/hackmd/Sknmienxbl.png)
...
**Right case**
![截圖 2025-11-20 上午10.33.50](/images/hackmd/r1KM0ehl-e.png)
