...
![System call](/images/sp/ch07-signal/system-call.png)
...
![Signal succeed](/images/sp/ch07-signal/signal-succeed.png)
...
### Reentrant Function
<Aside type="tip" title="Example">
![Reentrant Function 1](/images/sp/ch07-signal/reentrant-function-1.png)
</Aside>
...
![Reentrant Function 2](/images/sp/ch07-signal/reentrant-function-2.png)
...
### Reliable Signals
- 紀錄時間，把它分成兩個 phase 
![Reliable Signals](/images/sp/ch07-signal/reliable-signals.png)
...
![nonlocal jump](/images/sp/ch07-signal/nonlocal-jump.png)
...
### Idea: 必定由深層到淺層跳
![Idea: 必定由深層到淺層跳 1](/images/sp/ch07-signal/idea-1.png)
- 這個 code 可以 call 因為他的 stack 順序是正確的

![Idea: 必定由深層到淺層跳 2](/images/sp/ch07-signal/idea-2.png)
- 壓掉 `P2` 後還繼續跳 `P2` 不行
</Aside>

<Aside type="note" title="Co-routine">
- 雖然理論上不能從淺層往深層 jump，但實務上我們會用這個方法做 co-routine
![Idea: 必定由深層到淺層跳 3](/images/sp/ch07-signal/idea-3.png)
- 紅色代表當前的 `top`
...
![Idea: 必定由深層到淺層跳 4](/images/sp/ch07-signal/idea-4.png)
...
![Signal mask 1](/images/sp/ch07-signal/signal-mask-1.png)
...
![Signal mask 2](/images/sp/ch07-signal/signal-mask-2.png)
1. 開始時 mask 為 empty
...
### IPC with signal
**Wrong case**
![IPC with signal 1](/images/sp/ch07-signal/ipc-with-signal-1.png)
...
**Right case**
![IPC with signal 2](/images/sp/ch07-signal/ipc-with-signal-2.png)
