...
<Fig src="/images/sp/ch07-signal/system-call.webp" caption="System call" />
...
<Fig src="/images/sp/ch07-signal/signal-succeed.webp" caption="Signal succeed" />
...
### Reentrant Function
<Aside type="tip" title="Example">
<Fig src="/images/sp/ch07-signal/reentrant-function-1.webp" caption="Reentrant Function 1" />
</Aside>
...
<Fig src="/images/sp/ch07-signal/reentrant-function-2.webp" caption="Reentrant Function 2" />
...
### Reliable Signals
- 紀錄時間，把它分成兩個 phase 
<Fig src="/images/sp/ch07-signal/reliable-signals.webp" caption="Reliable Signals" />
...
<Fig src="/images/sp/ch07-signal/nonlocal-jump.webp" caption="nonlocal jump" />
...
### Idea: 必定由深層到淺層跳
<Fig src="/images/sp/ch07-signal/idea-1.webp" caption="Idea: 必定由深層到淺層跳 1" />
- 這個 code 可以 call 因為他的 stack 順序是正確的

<Fig src="/images/sp/ch07-signal/idea-2.webp" caption="Idea: 必定由深層到淺層跳 2" />
- 壓掉 `P2` 後還繼續跳 `P2` 不行
</Aside>

<Aside type="note" title="Co-routine">
- 雖然理論上不能從淺層往深層 jump，但實務上我們會用這個方法做 co-routine
<Fig src="/images/sp/ch07-signal/idea-3.webp" caption="Idea: 必定由深層到淺層跳 3" />
- 紅色代表當前的 `top`
...
<Fig src="/images/sp/ch07-signal/idea-4.webp" caption="Idea: 必定由深層到淺層跳 4" />
...
<Fig src="/images/sp/ch07-signal/signal-mask-1.webp" caption="Signal mask 1" />
...
<Fig src="/images/sp/ch07-signal/signal-mask-2.webp" caption="Signal mask 2" />
1. 開始時 mask 為 empty
...
### IPC with signal
**Wrong case**
<Fig src="/images/sp/ch07-signal/ipc-with-signal-1.webp" caption="IPC with signal 1" />
...
**Right case**
<Fig src="/images/sp/ch07-signal/ipc-with-signal-2.webp" caption="IPC with signal 2" />
