...
<Fig src="/images/sp/ch03-advio/fig-1.webp" caption="non-blocking mode for a file" />
...
<Fig src="/images/sp/ch03-advio/fig-2.webp" caption="Terminal Circular Buffer" />
...
<Fig src="/images/sp/ch03-advio/i-o-multiplexing.webp" caption="Illustration of select()" />
...
<Fig src="/images/sp/ch03-advio/file-lock.webp" caption="Race condition on two processes writing a file" />
...
<Fig src="/images/sp/ch03-advio/type-of-lock-1.webp" caption="The type of lock" />
...
<Fig src="/images/sp/ch03-advio/type-of-lock-2.webp" caption="Process Structure and Lock in FreeBSD" />
...
<Fig src="/images/sp/ch03-advio/advisory-lock.webp" caption="Advisory lock" />

#### Mandatory lock
所有 system call 都要先透過 kernel 去檢查 lock 的狀態，才可以 access file，也只有 kernel 才有權限碰到 lock，所有 process 都只能提出 request

<Fig src="/images/sp/ch03-advio/mandatory-lock.webp" caption="Mandatory lock" />
...
<Fig src="/images/sp/ch03-advio/networking-2.webp" caption="Client Server model" />
...
<Fig src="/images/sp/ch03-advio/networking-1.webp" caption="Networking Stack" />
