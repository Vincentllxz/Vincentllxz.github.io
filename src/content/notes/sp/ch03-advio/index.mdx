...
- ![figure 1](/images/sp/ch03-advio/fig-1.png)
...
![figure 2](/images/sp/ch03-advio/fig-2.png)
...
- ![I/O Multiplexing](/images/sp/ch03-advio/i-o-multiplexing.png)
...
![File Lock](/images/sp/ch03-advio/file-lock.png)
...
### Type of Lock
![Type of Lock 1](/images/sp/ch03-advio/type-of-lock-1.png)
- Shared read lock
    - 可以多人共享
    - 但不在鎖裡面的人都不能讀
...
![Type of Lock 2](/images/sp/ch03-advio/type-of-lock-2.png)
...
- **Client** v.s. **Server**
    - **Client**: 提出 request
    - **Server**: 處理 request
![Networking 1](/images/sp/ch03-advio/networking-1.png)

**Socket Programming**
![Networking 2](/images/sp/ch03-advio/networking-2.png)
