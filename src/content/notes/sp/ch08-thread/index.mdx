...
<Fig src="/images/sp/ch08-thread/process-model.webp" caption="Process Model" />
...
### Thread Model
<Fig src="/images/sp/ch08-thread/thread-model.webp" caption="Thread Model" />
...
<Fig src="/images/sp/ch08-thread/thread.webp" caption="Thread" />
...
<Fig src="/images/sp/ch08-thread/implementing-of-thread-1.webp" caption="Implementing of Thread 1" />
...
<Fig src="/images/sp/ch08-thread/implementing-of-thread-2.webp" caption="Implementing of Thread 2" />
...
<Fig src="/images/sp/ch08-thread/hybrid-implementation.webp" caption="Hybrid Implementation" />
...
- Normal function call
  <Fig src="/images/sp/ch08-thread/thread-creation-1.webp" caption="Thread creation 1" />
- Threaded function call
  <Fig src="/images/sp/ch08-thread/thread-creation-2.webp" caption="Thread creation 2" />
...
<Fig src="/images/sp/ch08-thread/thread-cancel.webp" caption="Thread Cancel" />
...
<Fig src="/images/sp/ch08-thread/thread-synchronization.webp" caption="Thread Synchronization" />
...
<Fig src="/images/sp/ch08-thread/mutexes.webp" caption="Mutexes" />
...
<Fig src="/images/sp/ch08-thread/memory-mapped-i-o-1.webp" caption="Memory-mapped I/O 1" />
...
<Fig src="/images/sp/ch08-thread/memory-mapped-i-o-2.webp" caption="Memory-mapped I/O 2" />
...
<Fig src="/images/sp/ch08-thread/memory-mapped-i-o-3.webp" caption="Memory-mapped I/O 3" />
...
<Fig src="/images/sp/ch08-thread/memory-mapped-i-o-4.webp" caption="Memory-mapped I/O 4" />

- 兩個 share 到同一份 resource 同時要改，可以上 mutex lock，並且 lock 也要放在 share memory
    - init 要在 `fork()` 前就上好
    - 在 process 裡面才去爭 lock

<Fig src="/images/sp/ch08-thread/memory-mapped-i-o-5.webp" caption="Memory-mapped I/O 5" />
...
<Fig src="/images/sp/ch08-thread/thread-pool.webp" caption="Thread Pool" />
...
<Fig src="/images/sp/ch08-thread/thread-safe-1.webp" caption="Thread safe 1" />

<Aside type="note" title="">
<Fig src="/images/sp/ch08-thread/thread-safe-2.webp" caption="Thread safe 2" />
