...
description: "NTU System Programming 系統程式設計:Ch8 Thread model"
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/process-model.webp" style="width: 100%;" />
  <br />
...
### Thread Model
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/thread-model.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Thread Model
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/thread.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Thread
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/implementing-of-thread-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/implementing-of-thread-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/hybrid-implementation.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Hybrid Implementation
  </span>
...
- Normal function call
  <div style="text-align: center;">
    <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/thread-creation-1.webp" style="width: 100%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
       Thread creation 1
    </span>
...
- Threaded function call
  <div style="text-align: center;">
    <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/thread-creation-2.webp" style="width: 100%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
       Thread creation 2
    </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/thread-cancel.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Thread Cancel
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/thread-synchronization.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Thread Synchronization
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/mutexes.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Mutexes
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/memory-mapped-i-o-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Memory-mapped I/O 1
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/memory-mapped-i-o-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Memory-mapped I/O 2
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/memory-mapped-i-o-3.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Memory-mapped I/O 3
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/memory-mapped-i-o-4.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Memory-mapped I/O 4
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/memory-mapped-i-o-5.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Memory-mapped I/O 5
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/thread-pool.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Thread Pool
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/thread-safe-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Thread safe 1
  </span>
...
<Aside type="note" title="">
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch08-thread/thread-safe-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Thread safe 2
  </span>
