...
<Fig src="/images/sp/ch04-bufio/standard-library-of-c-1.webp" caption="Standard Library of C 1" />
- 依然會透過 Unbuffered I/O 出去，只是在包裝而已
- `strace` 可以 trace 所有 Buffer I/O
</Aside>

<Aside type="note" title="">
<Fig src="/images/sp/ch04-bufio/standard-library-of-c-2.webp" caption="Standard Library of C 2" />
- C library 會 allocate 一塊 buffer 去防止直接碰到 Kernel
- 直接碰到 system call 是 high cost 的
- 有 Prefetch 的效果
<Fig src="/images/sp/ch04-bufio/standard-library-of-c-3.webp" caption="Standard Library of C 3" />
</Aside>
