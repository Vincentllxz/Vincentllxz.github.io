...
![Standard Library of C 1](/images/sp/ch04-bufio/standard-library-of-c-1.png)
- 依然會透過 Unbuffered I/O 出去，只是在包裝而已
- `strace` 可以 trace 所有 Buffer I/O
</Aside>

<Aside type="note" title="">
![Standard Library of C 2](/images/sp/ch04-bufio/standard-library-of-c-2.png)
- C library 會 allocate 一塊 buffer 去防止直接碰到 Kernel
- 直接碰到 system call 是 high cost 的
- 有 Prefetch 的效果
![Standard Library of C 3](/images/sp/ch04-bufio/standard-library-of-c-3.png)
</Aside>

**`FILE *fopen(const char *pathname, const char *type);`**
- 可以 support atomic operation
- ![Standard Library of C 4](/images/sp/ch04-bufio/standard-library-of-c-4.png)
...
![Character-at-a-time I/O 1](/images/sp/ch04-bufio/character-at-a-time-i-o-1.png)
- 為了 alignment Data Bus 的寬度，減少 CPU clock cycle
![Character-at-a-time I/O 2](/images/sp/ch04-bufio/character-at-a-time-i-o-2.png)
</Aside>
