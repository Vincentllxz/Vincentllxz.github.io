...
![System call v.s Function call](/images/sp/ch01-oscon/system-call-v-s-function-call.png)

### User mode v.s. Kernel mode

![User mode v.s. Kernel mode](/images/sp/ch01-oscon/user-mode-v-s-kernel-mode.png)
...
![CPU Scheduling 1](/images/sp/ch01-oscon/cpu-scheduling-1.png)

- Event can be DISK
- **(IMPROTANT)** A process want to inline of ready queue, it has to put every data into the memory.

![CPU Scheduling 2](/images/sp/ch01-oscon/cpu-scheduling-2.png)
...
![CPU Scheduling 3](/images/sp/ch01-oscon/cpu-scheduling-3.png)

- Exit have many kind.

![CPU Scheduling 4](/images/sp/ch01-oscon/cpu-scheduling-4.png)
...
### UNIX Process
![UNIX Process 1](/images/sp/ch01-oscon/unix-process-1.png)

From "init" prcess use **fork** to build a process tree.

![UNIX Process 2](/images/sp/ch01-oscon/unix-process-2.png)
...
![Memory Management](/images/sp/ch01-oscon/memory-management.png)
...
![File Structure 1](/images/sp/ch01-oscon/file-structure-1.png)
...
![File Structure 2](/images/sp/ch01-oscon/file-structure-2.png)
