...
<div style="text-align: center;">
  <img src="/images/sp/ch01-oscon/system-call-v-s-function-call.webp" style="width: 70%;" />
  <br />
...
<div style="text-align: center;">
  <img src="/images/sp/ch01-oscon/user-mode-v-s-kernel-mode.webp" style="width: 70%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     User space v.s. Kernel space
  </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch01-oscon/cpu-scheduling-1.webp" style="width: 90%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
1. CPU 會從 ready queue 裡面選擇一個 process 來執行
  <div style="text-align: center;">
    <img src="/images/sp/ch01-oscon/cpu-scheduling-2.webp" style="width: 90%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
...
2. CPU 正在執行 process
  <div style="text-align: center;">
    <img src="/images/sp/ch01-oscon/cpu-scheduling-3.webp" style="width: 90%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
...
3. CPU 把正在執行的 task 踢掉
  <div style="text-align: center;">
    <img src="/images/sp/ch01-oscon/cpu-scheduling-4.webp" style="width: 90%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
...
4. 在這個 time slice，Process A 會被放回 ready queue 裡面，等待下一次被 CPU 選中來執行，同一時間，CPU 會從 ready queue 裡面選擇下一個 process 來執行
  <div style="text-align: center;">
    <img src="/images/sp/ch01-oscon/cpu-scheduling-5.webp" style="width: 90%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
...
5. 如果這個 process 被踢出是因為 Event 的話，那麼這個 process 就不會在那個 time slice 裡面被放回 ready queue 裡面，而是會被放到 waiting queue 裡面，等到 Event 處理完了之後，再把這個 process 放回 ready queue 裡面等待下一次被 CPU 選中來執行
  <div style="text-align: center;">
    <img src="/images/sp/ch01-oscon/cpu-scheduling-6.webp" style="width: 90%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
...
6. 當 event 來的時候，這個 process 就會自行對 event 做出反應
  <div style="text-align: center;">
    <img src="/images/sp/ch01-oscon/cpu-scheduling-7.webp" style="width: 90%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
...
7. 當 event 處理完了之後，這個 process 就會被放回 ready queue 裡面等待下一次被 CPU 選中來執行
  <div style="text-align: center;">
    <img src="/images/sp/ch01-oscon/cpu-scheduling-8.webp" style="width: 90%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/sp/ch01-oscon/unix-process-1.webp" style="width: 90%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/sp/ch01-oscon/unix-process-2.webp" style="width: 90%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     UNIX Process tree
  </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch01-oscon/memory-management.webp" style="width: 50%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Memory Management
  </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch01-oscon/file-structure-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/sp/ch01-oscon/file-structure-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     File in Unix
  </span>
