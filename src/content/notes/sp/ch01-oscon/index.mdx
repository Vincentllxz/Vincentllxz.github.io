...
![截圖 2025-11-30 凌晨1.03.27](/images/hackmd/SkluDs_Z-g.png)

### User mode v.s. Kernel mode

![截圖 2025-11-30 凌晨1.15.38](/images/hackmd/B1KS5su-Zl.png)
...
![截圖 2025-09-11 上午9.55.14](/images/hackmd/BkbGhs1sgx.png)

- Event can be DISK
- **(IMPROTANT)** A process want to inline of ready queue, it has to put every data into the memory.

![截圖 2025-09-11 上午10.00.21](/images/hackmd/HJer6okjee.png)
...
![截圖 2025-09-11 上午10.06.48](/images/hackmd/HyVTCiyiex.png)

- Exit have many kind.

![截圖 2025-09-11 上午10.09.00](/images/hackmd/S1x_r121ixg.png)
...
### UNIX Process
![截圖 2025-09-11 上午10.32.53](/images/hackmd/S1bJr31jgl.png)

From "init" prcess use **fork** to build a process tree.

![截圖 2025-09-11 上午10.42.34](/images/hackmd/HkBmP2kjxl.png)
...
![截圖 2025-11-18 晚上11.26.31](/images/hackmd/Byp9eM9eWg.png)
...
![截圖 2025-09-11 上午10.58.54](/images/hackmd/S1qgsh1sel.png)
