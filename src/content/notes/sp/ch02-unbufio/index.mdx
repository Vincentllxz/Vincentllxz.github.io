...
<div style="text-align: center;">
  <img src="/images/sp/ch02-unbufio/fig-1.webp" style="width: 100%;" />
  <br />
...
<div style="text-align: center;">
  <img src="/images/sp/ch02-unbufio/fig-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     figure 2
  </span>
...
- Due to the DISK's (HDD) movement, it will read a "**block**" which is the cylinder of a section instead of "**byte**".
    ...
    <div style="text-align: center;">
      <img src="/images/sp/ch02-unbufio/fig-3.webp" style="width: 100%;" />
      <br />
      <span style="color: grey; font-size: 16px;">
         figure 3
      </span>
...
- For SSD, it have read the data from page to page
    ...
    <div style="text-align: center;">
      <img src="/images/sp/ch02-unbufio/fig-4.webp" style="width: 100%;" />
      <br />
      <span style="color: grey; font-size: 16px;">
         figure 4
      </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch02-unbufio/fig-5.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     figure 5
  </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch02-unbufio/process-structure-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Process Structure 1
  </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch02-unbufio/process-structure-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Process Structure 2
  </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch02-unbufio/process-structure-3.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Process Structure 3
  </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch02-unbufio/blocking-vs-synchronization-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Blocking vs. Synchronization 1
  </span>
</div>

<div style="text-align: center;">
  <img src="/images/sp/ch02-unbufio/blocking-vs-synchronization-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Blocking vs. Synchronization 2
  </span>
</div>
...
- <div style="text-align: center;">
    <img src="/images/sp/ch02-unbufio/blocking-vs-synchronization-3.webp" style="width: 100%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
       Blocking vs. Synchronization 3
    </span>
  </div>
- pipe 無法進行 `lseek`，有些有名稱的 pipe 會以檔案形式呈現

<div style="text-align: center;">
  <img src="/images/sp/ch02-unbufio/blocking-vs-synchronization-4.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/sp/ch02-unbufio/blocking-vs-synchronization-5.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
- 萬一出現這種情況就會發生問題
  <div style="text-align: center;">
    <img src="/images/sp/ch02-unbufio/blocking-vs-synchronization-6.webp" style="width: 100%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
...
- Open with `O_DSYNC` 就不會 delay `write()`，Context swtich  的時候會直接把 kernel buffer 的 i-node table attribute 寫到 DISK i-node 去
    - <div style="text-align: center;">
        <img src="/images/sp/ch02-unbufio/blocking-vs-synchronization-7.webp" style="width: 100%;" />
        <br />
        <span style="color: grey; font-size: 16px;">
...
- Open with `O_SYNC` 對 return time 更加嚴格
    - <div style="text-align: center;">
        <img src="/images/sp/ch02-unbufio/blocking-vs-synchronization-8.webp" style="width: 100%;" />
        <br />
        <span style="color: grey; font-size: 16px;">
...
- Open with `O_RSYNC` 會在 `read()` 的時候進行同步
    - <div style="text-align: center;">
        <img src="/images/sp/ch02-unbufio/blocking-vs-synchronization-9.webp" style="width: 100%;" />
        <br />
        <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/sp/ch02-unbufio/i-o-efficiency.webp" style="width: 50%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     I/O Efficiency
  </span>
...
### Read ahead
<div style="text-align: center;">
  <img src="/images/sp/ch02-unbufio/read-ahead-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Read ahead 1
  </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch02-unbufio/read-ahead-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Read ahead 2
  </span>
