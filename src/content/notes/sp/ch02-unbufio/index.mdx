...
![figure 1](/images/sp/ch02-unbufio/fig-1.png)
...
![figure 2](/images/sp/ch02-unbufio/fig-2.png)
...
- Due to the DISK's (HDD) movement, it will read a "**block**" which is the cylinder of a section instead of "**byte**".
    ...
    ![figure 3](/images/sp/ch02-unbufio/fig-3.png)
...
- For SSD, it have read the data from page to page
    ...
    ![figure 4](/images/sp/ch02-unbufio/fig-4.png)

---

![figure 5](/images/sp/ch02-unbufio/fig-5.png)
...
![Process Structure 1](/images/sp/ch02-unbufio/process-structure-1.png)
...
![Process Structure 2](/images/sp/ch02-unbufio/process-structure-2.png)
...
![Process Structure 3](/images/sp/ch02-unbufio/process-structure-3.png)
...
![Blocking vs. Synchronization 1](/images/sp/ch02-unbufio/blocking-vs-synchronization-1.png)

![Blocking vs. Synchronization 2](/images/sp/ch02-unbufio/blocking-vs-synchronization-2.png)
...
- ![Blocking vs. Synchronization 3](/images/sp/ch02-unbufio/blocking-vs-synchronization-3.png)
- pipe 無法進行 `lseek`，有些有名稱的 pipe 會以檔案形式呈現

![Blocking vs. Synchronization 4](/images/sp/ch02-unbufio/blocking-vs-synchronization-4.png)
...
![Blocking vs. Synchronization 5](/images/sp/ch02-unbufio/blocking-vs-synchronization-5.png)
...
- 萬一出現這種情況就會發生問題![Blocking vs. Synchronization 6](/images/sp/ch02-unbufio/blocking-vs-synchronization-6.png)
...
- Open with `O_DSYNC` 就不會 delay `write()`，Context swtich  的時候會直接把 kernel buffer 的 i-node table attribute 寫到 DISK i-node 去
    - ![Blocking vs. Synchronization 7](/images/sp/ch02-unbufio/blocking-vs-synchronization-7.png)
- Open with `O_SYNC` 對 return time 更加嚴格
    - ![Blocking vs. Synchronization 8](/images/sp/ch02-unbufio/blocking-vs-synchronization-8.png)
- Open with `O_RSYNC` 會在 `read()` 的時候進行同步
    - ![Blocking vs. Synchronization 9](/images/sp/ch02-unbufio/blocking-vs-synchronization-9.png)
...
![I/O Efficiency](/images/sp/ch02-unbufio/i-o-efficiency.png =50%x)

### Read ahead
![Read ahead 1](/images/sp/ch02-unbufio/read-ahead-1.png)
...
![Read ahead 2](/images/sp/ch02-unbufio/read-ahead-2.png)
- 這次把 `write()` 真正做出來
