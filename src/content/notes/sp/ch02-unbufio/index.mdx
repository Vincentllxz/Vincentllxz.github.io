...
<Fig src="/images/sp/ch02-unbufio/fig-2.webp" caption="Unbuffered I/O" />
...
<Fig src="/images/sp/ch02-unbufio/fig-5.webp" caption="Unbuffered I/O with Buffer Cache" />
...
<Fig src="/images/sp/ch02-unbufio/process-structure-2.webp" caption='"Buffer" of Buffer I/O' />
...
<Fig src="/images/sp/ch02-unbufio/process-structure-1.webp" caption="The Unix Process Structure" />
...
<Fig src="/images/sp/ch02-unbufio/process-structure-3.webp" caption="Metadata, Content, Reference Count" />
...
<Fig src="/images/sp/ch02-unbufio/blocking-vs-synchronization-3.webp" caption="The operation on a file, and current file offset" />
...
<Fig src="/images/sp/ch02-unbufio/blocking-vs-synchronization-5.webp" caption="Delay Write" />
</Aside>
...
<Fig src="/images/sp/ch02-unbufio/blocking-vs-synchronization-1.webp" caption="Two process open the same file" />
...
<Fig src="/images/sp/ch02-unbufio/blocking-vs-synchronization-2.webp" caption="Successive of parent process and child process" />
...
<Fig src="/images/sp/ch02-unbufio/blocking-vs-synchronization-6.webp" caption="Problem of non-atomic operation" />
...
<Fig src="/images/sp/ch02-unbufio/blocking-vs-synchronization-7.webp" caption="The illustration of O_DSYNC" />

2. **`O_SYNC`**：對 return time 更加嚴格，當有任何 `write()` 操作的時候，system 會直接執行 disk I/O 把 content 跟 metadata 都寫到 disk 去，等到 disk 寫完了才會 return
<Fig src="/images/sp/ch02-unbufio/blocking-vs-synchronization-8.webp" caption="The illustration of O_SYNC" />

3. **`O_RSYNC`**：針對 `read()` 的 protection，確保在 `read()` 回傳之前，該檔案所有在 cache 的 Dirty Pages，都已經被強制同步到 disk 上
<Fig src="/images/sp/ch02-unbufio/blocking-vs-synchronization-9.webp" caption="The illustration of O_RSYNC" />
...
<Fig src="/images/sp/ch02-unbufio/i-o-efficiency.webp" caption="The illustration of I/O Efficiency" />
