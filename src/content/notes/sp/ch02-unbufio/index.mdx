...
![截圖 2025-09-11 上午11.21.38](/images/hackmd/ryTHgTkigg.png)
...
![截圖 2025-09-11 上午11.27.23](/images/hackmd/BJUjb6kilx.png)
...
- Due to the DISK's (HDD) movement, it will read a "**block**" which is the cylinder of a section instead of "**byte**".
    ...
    ![截圖 2025-09-11 上午11.32.43](/images/hackmd/S1Yl76Joxg.png)
...
- For SSD, it have read the data from page to page
    ...
    ![截圖 2025-09-11 上午11.35.04](/images/hackmd/HykYXpyjxx.png)

---

![截圖 2025-09-11 上午11.38.33](/images/hackmd/SkErEp1sex.png)
...
![截圖 2025-09-11 上午11.43.48](/images/hackmd/SkyFSpksxg.png)
...
![截圖 2025-09-11 上午11.49.04](/images/hackmd/H1a3IaJslg.png)
...
![截圖 2025-09-18 上午9.33.46](/images/hackmd/S1uF-1Yoxx.png)
...
![截圖 2025-09-18 上午10.48.07](/images/hackmd/S1HxQgKogg.png)

![截圖 2025-09-18 上午10.50.09](/images/hackmd/B13DQxFoge.png)
...
- ![截圖 2025-09-18 上午11.05.08](/images/hackmd/BJkxDltjlx.png)
- pipe 無法進行 `lseek`，有些有名稱的 pipe 會以檔案形式呈現

![截圖 2025-09-18 上午11.12.26](/images/hackmd/B1Bidltolx.png)
...
![截圖 2025-10-17 上午9.45.09](/images/hackmd/HyXaJ7y0le.png)
...
- 萬一出現這種情況就會發生問題![截圖 2025-09-18 上午11.40.44](/images/hackmd/H1OH1-Ysel.png)
...
- Open with `O_DSYNC` 就不會 delay `write()`，Context swtich  的時候會直接把 kernel buffer 的 i-node table attribute 寫到 DISK i-node 去
    - ![截圖 2025-09-25 上午9.17.19](/images/hackmd/BJqm_MMhxl.png)
- Open with `O_SYNC` 對 return time 更加嚴格
    - ![截圖 2025-09-25 上午9.17.44](/images/hackmd/HJGSdMG2gx.png)
- Open with `O_RSYNC` 會在 `read()` 的時候進行同步
    - ![截圖 2025-09-25 上午9.19.29](/images/hackmd/By3odMMhll.png)
...
![截圖 2025-10-17 上午10.02.47](/images/hackmd/SJQR7QJCeg.png =50%x)

### Read ahead
![截圖 2025-10-17 上午10.28.26](/images/hackmd/SyNAKmkCxx.png)
...
![截圖 2025-10-17 上午10.39.41](/images/hackmd/Hye9dh7kCgl.png)
- 這次把 `write()` 真正做出來
