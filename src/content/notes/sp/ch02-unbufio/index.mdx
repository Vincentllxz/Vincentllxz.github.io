...
## Process Structure
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch02-unbufio/process-structure-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Process Structure 1
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch02-unbufio/process-structure-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Process Structure 2
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch02-unbufio/process-structure-3.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch02-unbufio/blocking-vs-synchronization-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch02-unbufio/blocking-vs-synchronization-2.webp" style="width: 70%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch02-unbufio/blocking-vs-synchronization-4.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Blocking vs. Synchronization 4
  </span>
</div>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch02-unbufio/blocking-vs-synchronization-5.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Blocking vs. Synchronization 5
  </span>
</div>
...
- 萬一出現這種情況就會發生問題
  <div style="text-align: center;">
    <img loading="lazy" decoding="async" src="/images/sp/ch02-unbufio/blocking-vs-synchronization-6.webp" style="width: 100%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
       Blocking vs. Synchronization 6
    </span>
  </div>
...
- Open with `O_DSYNC` 就不會 delay `write()`，Context swtich  的時候會直接把 kernel buffer 的 i-node table attribute 寫到 DISK i-node 去
    - <div style="text-align: center;">
        <img loading="lazy" decoding="async" src="/images/sp/ch02-unbufio/blocking-vs-synchronization-7.webp" style="width: 100%;" />
        <br />
        <span style="color: grey; font-size: 16px;">
           Blocking vs. Synchronization 7
        </span>
      </div>
- Open with `O_SYNC` 對 return time 更加嚴格
    - <div style="text-align: center;">
        <img loading="lazy" decoding="async" src="/images/sp/ch02-unbufio/blocking-vs-synchronization-8.webp" style="width: 100%;" />
        <br />
        <span style="color: grey; font-size: 16px;">
           Blocking vs. Synchronization 8
        </span>
      </div>
- Open with `O_RSYNC` 會在 `read()` 的時候進行同步
    - <div style="text-align: center;">
        <img loading="lazy" decoding="async" src="/images/sp/ch02-unbufio/blocking-vs-synchronization-9.webp" style="width: 100%;" />
        <br />
        <span style="color: grey; font-size: 16px;">
           Blocking vs. Synchronization 9
        </span>
      </div>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch02-unbufio/i-o-efficiency.webp" style="width: 50%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     I/O Efficiency
  </span>
...
### Read ahead
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch02-unbufio/read-ahead-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Read ahead 1
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/sp/ch02-unbufio/read-ahead-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Read ahead 2
  </span>
