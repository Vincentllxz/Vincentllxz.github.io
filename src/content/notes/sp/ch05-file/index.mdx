...
- **Set GID/UID**
    ...
    ![GID, UID 1](/images/sp/ch05-file/gid-uid-1.png)
    - Real-id: B
    - Effective-id: **B**
    ...
    <Aside type="tip" title="">
    ![GID, UID 2](/images/sp/ch05-file/gid-uid-2.png)
    - Real-id: B
    - Effective-id: **A**
...
- **Partition**
    ...
    - 多個 cylinder groups 組成 (Hard Drive)
        ...
        - **Data blocks**
        - **Data blocks map**
    - ![Structure 1](/images/sp/ch05-file/structure-1.png)
- **i-node list** (fix list)
    - ![Structure 2](/images/sp/ch05-file/structure-2.png)
    - 記錄**佔用哪些 DISK block**
    ...
    - ![Structure 3](/images/sp/ch05-file/structure-3.png)
- File operation
    - move 檔案只需要改一改 i-node 的值就好了
    - delete 就是 link count -1 
- Example: 4.4BSD i-node
    - ![Structure 4](/images/sp/ch05-file/structure-4.png)
...
![Structure 5](/images/sp/ch05-file/structure-5.png)
### Hard link & Soft link 
- Hard link
    - 只有 SU 可以對一個 directory create 一個 hard link
    - 不能 Cross file system
    - ![Hard link & Soft link 1](/images/sp/ch05-file/hard-link-and-soft-link-1.png)
- Soft link (Symbolic link)
    ...
    - ![Hard link & Soft link 2](/images/sp/ch05-file/hard-link-and-soft-link-2.png)
