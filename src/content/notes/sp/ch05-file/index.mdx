...
- **Set GID/UID**
    ...
    <div style="text-align: center;">
      <img src="/images/sp/ch05-file/gid-uid-1.png" style="width: 100%;" />
      <br />
    ...
    <Aside type="tip" title="">
    <div style="text-align: center;">
      <img src="/images/sp/ch05-file/gid-uid-2.png" style="width: 100%;" />
      <br />
      <span style="color: grey; font-size: 16px;">
         GID, UID 2
      </span>
...
- **Partition**
    ...
    - 多個 cylinder groups 組成 (Hard Drive)
        ...
        - **Data blocks map**
    - <div style="text-align: center;">
        <img src="/images/sp/ch05-file/structure-1.png" style="width: 100%;" />
        <br />
        <span style="color: grey; font-size: 16px;">
           Structure 1
        </span>
...
- **i-node list** (fix list)
    - <div style="text-align: center;">
        <img src="/images/sp/ch05-file/structure-2.png" style="width: 100%;" />
        <br />
        <span style="color: grey; font-size: 16px;">
           Structure 2
        </span>
    ...
    - <div style="text-align: center;">
        <img src="/images/sp/ch05-file/structure-3.png" style="width: 100%;" />
        <br />
        <span style="color: grey; font-size: 16px;">
           Structure 3
        </span>
...
- Example: 4.4BSD i-node
    - <div style="text-align: center;">
        <img src="/images/sp/ch05-file/structure-4.png" style="width: 100%;" />
        <br />
        <span style="color: grey; font-size: 16px;">
           Structure 4
        </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch05-file/structure-5.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Structure 5
  </span>
...
- Hard link
    ...
    - <div style="text-align: center;">
        <img src="/images/sp/ch05-file/hard-link-and-soft-link-1.png" style="width: 100%;" />
        <br />
        <span style="color: grey; font-size: 16px;">
...
- Soft link (Symbolic link)
    ...
    - <div style="text-align: center;">
        <img src="/images/sp/ch05-file/hard-link-and-soft-link-2.png" style="width: 100%;" />
        <br />
        <span style="color: grey; font-size: 16px;">
