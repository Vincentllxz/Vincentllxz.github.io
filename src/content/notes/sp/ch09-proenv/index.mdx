...
![截圖 2025-12-11 晚上8.08.25](/images/hackmd/SkOrENdGbx.png)

會幫忙傳各種參數跟初始化，最後 return 會幫忙做 clean up.  

![截圖 2025-12-11 晚上8.02.25](/images/hackmd/H1iRfVdfZe.png)
...
#### C language compile
![截圖 2025-12-11 下午6.40.54](/images/hackmd/Hkxpy7_G-g.png)
...
![截圖 2025-12-11 晚上7.15.38](/images/hackmd/BJiJdXdG-x.png)
...
![截圖 2025-12-11 下午6.59.24](/images/hackmd/B1wfN7dGWl.png)
...
#### Relocation
![截圖 2025-12-11 晚上7.16.52](/images/hackmd/S1RmuX_MWl.png)
...
![截圖 2025-12-11 晚上8.20.41](/images/hackmd/ryD7PN_MZe.png)


會用 Loader 把它放進去

![截圖 2025-12-11 晚上7.45.43](/images/hackmd/SkfeyE_fZe.png)

## Virtual memory

不可能讓他直接 map 到某個位置，記憶體根本不夠用，中間有一大段全都是洞，根本沒有存資料，就不用 map 上去

 ![截圖 2025-12-11 晚上8.25.35](/images/hackmd/HknBu4dGZg.png)

其實是用很像 copy on write 的方法，讓大家可以用同一塊 physical memory 

![截圖 2025-12-11 晚上8.26.36](/images/hackmd/SkFtdV_fWg.png)
...
![截圖 2025-12-11 晚上8.32.03](/images/hackmd/BJCpF4dG-x.png)
...
![截圖 2025-12-11 晚上8.42.58](/images/hackmd/SJ6InNdz-g.png)

取出來之後就直接是正確的位置了

![截圖 2025-12-11 晚上8.44.40](/images/hackmd/rJXa24_zbe.png)
...
![截圖 2025-12-11 晚上9.06.01](/images/hackmd/H1H6brOMbg.png)
![截圖 2025-12-11 晚上9.06.09](/images/hackmd/r1TpWSOz-e.png)
</Aside>
...
![截圖 2025-12-11 晚上9.25.28](/images/hackmd/rk7ILHdGZe.png)
2. Keep track of free block: 可能把 free 的 memory 用 link list 串接起來 
![截圖 2025-12-11 晚上9.27.52](/images/hackmd/B1m1PH_zbx.png)
</Aside>
