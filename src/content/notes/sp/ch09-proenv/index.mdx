...
<Fig src="/images/sp/ch09-proenv/main-function-1.webp" caption="main function 1" />

會幫忙傳各種參數跟初始化，最後 return 會幫忙做 clean up.  

<Fig src="/images/sp/ch09-proenv/main-function-2.webp" caption="main function 2" />
...
#### C language compile
<Fig src="/images/sp/ch09-proenv/c-language-compile.webp" caption="C language compile" />
...
<Fig src="/images/sp/ch09-proenv/elf-object-file-format.webp" caption="ELF object file format" />
...
<Fig src="/images/sp/ch09-proenv/linking.webp" caption="Linking" />
...
#### Relocation
<Fig src="/images/sp/ch09-proenv/relocation.webp" caption="Relocation" />
...
<Fig src="/images/sp/ch09-proenv/memory-layout-of-process-1.webp" caption="Memory Layout of Process 1" />


會用 Loader 把它放進去

<Fig src="/images/sp/ch09-proenv/memory-layout-of-process-2.webp" caption="Memory Layout of Process 2" />

## Virtual memory

不可能讓他直接 map 到某個位置，記憶體根本不夠用，中間有一大段全都是洞，根本沒有存資料，就不用 map 上去

 <Fig src="/images/sp/ch09-proenv/virtual-memory-1.webp" caption="Virtual memory 1" />

其實是用很像 copy on write 的方法，讓大家可以用同一塊 physical memory 

<Fig src="/images/sp/ch09-proenv/virtual-memory-2.webp" caption="Virtual memory 2" />
...
<Fig src="/images/sp/ch09-proenv/translation-of-address-1.webp" caption="Translation of address 1" />
...
<Fig src="/images/sp/ch09-proenv/translation-of-address-2.webp" caption="Translation of address 2" />

取出來之後就直接是正確的位置了

<Fig src="/images/sp/ch09-proenv/translation-of-address-3.webp" caption="Translation of address 3" />
...
<Fig src="/images/sp/ch09-proenv/stack-frame-1.webp" caption="Stack Frame 1" />
<Fig src="/images/sp/ch09-proenv/stack-frame-2.webp" caption="Stack Frame 2" />
</Aside>
...
<Fig src="/images/sp/ch09-proenv/heap-1.webp" caption="Heap 1" />
2. Keep track of free block: 可能把 free 的 memory 用 link list 串接起來 
<Fig src="/images/sp/ch09-proenv/heap-2.webp" caption="Heap 2" />
</Aside>
