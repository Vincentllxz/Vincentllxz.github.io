...
![main function 1](/images/sp/ch09-proenv/main-function-1.png)

會幫忙傳各種參數跟初始化，最後 return 會幫忙做 clean up.  

![main function 2](/images/sp/ch09-proenv/main-function-2.png)
...
#### C language compile
![C language compile](/images/sp/ch09-proenv/c-language-compile.png)
...
![ELF object file format](/images/sp/ch09-proenv/elf-object-file-format.png)
...
![Linking](/images/sp/ch09-proenv/linking.png)
...
#### Relocation
![Relocation](/images/sp/ch09-proenv/relocation.png)
...
![Memory Layout of Process 1](/images/sp/ch09-proenv/memory-layout-of-process-1.png)


會用 Loader 把它放進去

![Memory Layout of Process 2](/images/sp/ch09-proenv/memory-layout-of-process-2.png)

## Virtual memory

不可能讓他直接 map 到某個位置，記憶體根本不夠用，中間有一大段全都是洞，根本沒有存資料，就不用 map 上去

 ![Virtual memory 1](/images/sp/ch09-proenv/virtual-memory-1.png)

其實是用很像 copy on write 的方法，讓大家可以用同一塊 physical memory 

![Virtual memory 2](/images/sp/ch09-proenv/virtual-memory-2.png)
...
![Translation of address 1](/images/sp/ch09-proenv/translation-of-address-1.png)
...
![Translation of address 2](/images/sp/ch09-proenv/translation-of-address-2.png)

取出來之後就直接是正確的位置了

![Translation of address 3](/images/sp/ch09-proenv/translation-of-address-3.png)
...
![Stack Frame 1](/images/sp/ch09-proenv/stack-frame-1.png)
![Stack Frame 2](/images/sp/ch09-proenv/stack-frame-2.png)
</Aside>
...
![Heap 1](/images/sp/ch09-proenv/heap-1.png)
2. Keep track of free block: 可能把 free 的 memory 用 link list 串接起來 
![Heap 2](/images/sp/ch09-proenv/heap-2.png)
</Aside>
