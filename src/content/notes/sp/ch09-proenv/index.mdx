...
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/main-function-1.png" style="width: 100%;" />
  <br />
...
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/main-function-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     main function 2
  </span>
...
#### C language compile
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/c-language-compile.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     C language compile
  </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/elf-object-file-format.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     ELF object file format
  </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/linking.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Linking
  </span>
...
#### Relocation
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/relocation.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Relocation
  </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/memory-layout-of-process-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/memory-layout-of-process-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
不可能讓他直接 map 到某個位置，記憶體根本不夠用，中間有一大段全都是洞，根本沒有存資料，就不用 map 上去
 ...
 <div style="text-align: center;">
   <img src="/images/sp/ch09-proenv/virtual-memory-1.png" style="width: 100%;" />
   <br />
   <span style="color: grey; font-size: 16px;">
      Virtual memory 1
   </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/virtual-memory-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Virtual memory 2
  </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/translation-of-address-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/translation-of-address-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/translation-of-address-3.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/stack-frame-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Stack Frame 1
  </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/stack-frame-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Stack Frame 2
  </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/heap-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Heap 1
  </span>
...
<div style="text-align: center;">
  <img src="/images/sp/ch09-proenv/heap-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Heap 2
  </span>
