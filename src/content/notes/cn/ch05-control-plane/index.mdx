...
<div style="text-align: center;">
  <img src="/images/cn/ch05-control-plane/fig.png" style="width: 100%;" />
  <br />
...
<div style="text-align: center;">
  <img src="/images/cn/ch05-control-plane/link-state-algorithm.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Link State Algorithm
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch05-control-plane/diffusion-information.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Diffusion Information
  </span>
...
每個 router 其實不知道自己是怎麼被送過來的，只知道是從哪來，要往哪裡去，所有資訊都是用 diffusion 的方式傳輸的
</Aside>

#### link cost exchange
<div style="text-align: center;">
  <img src="/images/cn/ch05-control-plane/link-cost-exchange-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/cn/ch05-control-plane/link-cost-exchange-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
這樣的 packet TTL 可能會監測到出現了 loop 會直接被丟掉或是 routing 捨棄，$O(n|E|)$ msg complexity 會變得很差 
</Aside>
