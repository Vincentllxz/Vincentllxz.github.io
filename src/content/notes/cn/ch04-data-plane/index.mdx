...
![截圖 2025-12-10 凌晨12.53.57](/images/hackmd/B1O4VRHfWl.png)
- 用統一的 distributed algorithm，router 之間的 algorithm 互相溝通形成 forwarding table
2. **Software-Defined Networking(SDN)**
![截圖 2025-12-10 凌晨12.55.28](/images/hackmd/SyjYVCSfZe.png)
...
![截圖 2025-12-10 凌晨1.24.42](/images/hackmd/HJSwoCHGZx.png)
...
![截圖 2025-12-10 凌晨1.42.08](/images/hackmd/Sk3u1JUGZg.png)
...
![截圖 2025-12-10 凌晨1.41.40](/images/hackmd/HJlDJJIfbg.png)
...
![截圖 2025-12-10 凌晨1.50.10](/images/hackmd/SJhLZ18z-e.png)
...
![截圖 2025-12-10 凌晨1.53.22](/images/hackmd/SknGzJIzbx.png)
對於這個 table
...
![截圖 2025-12-10 凌晨2.05.21](/images/hackmd/Syo1SkIzbe.png)

- Switching via **Memory**
    - First generation Routers
    - 這種 switching 就是另一種普通 I/O 而已
    ![截圖 2025-12-10 凌晨2.07.49](/images/hackmd/SkgFByIG-g.png)
- Switching via **Bus**
    - 從 input 輸入後，經由 bus connection 不經過 memory 直接前往 output
    - 限制就變成 bus 的頻寬
    ![截圖 2025-12-10 凌晨2.09.09](/images/hackmd/HJgAS1Lz-x.png)
- Switching via **Interconnection Network**
    - 本來是設計給 multiprocessor 用的一種傳輸方法
    - 通常不會用上面的形式，而是用 **multi-stage** 的形式
    ![截圖 2025-12-10 凌晨2.27.39](/images/hackmd/BJIm9k8f-g.png)
    - $8 \times 8$ 的設計但只需要 4 個中繼點就好了
    - 我們通常會想用 parellel 的形式去做傳送，可以讓速度大幅增加
    ![截圖 2025-12-10 凌晨2.30.32](/images/hackmd/S1GRck8zZx.png)
...
![截圖 2025-12-10 上午9.44.02](/images/hackmd/ByTDxLIM-e.png)
...
![截圖 2025-12-10 上午9.46.25](/images/hackmd/Bk0gZLLfWx.png)
...
- **Packet Scheduling** 要決定誰先執行
    ...
    ![截圖 2025-12-10 上午10.04.30](/images/hackmd/ryFNBIIzbe.png) 
        - 就是種最基本的 FIFO 結構
    - **Priority**
    ![截圖 2025-12-10 上午10.09.19](/images/hackmd/rkt8ULUMZe.png)
        - 會根據 ISP 的 Priority 去做分配，如果 packet prioty 高就會被存在 high priority queue
        ![截圖 2025-12-10 上午10.10.37](/images/hackmd/SJwsIUUG-l.png)
        - 雖然 packet 2 比 packet 3 還早到，但他們在 packet 1 處理完成的時候都已經進入 queue，所以會優先執行 high priority 的
    - **Round Robin** (RR) scheduling
    ![截圖 2025-12-10 上午10.14.44](/images/hackmd/HymswULfbe.png)
        - 一樣分成多個 queue，但這次執行順序是輪流，每個 queue equally 的輪流執行
    - **Weighted Fair Queuing (WFQ)**
    ![截圖 2025-12-10 上午10.16.37](/images/hackmd/ByxM_LLfWl.png)
...
以下是當代的 IP header 架構
![截圖 2025-12-10 上午11.58.35](/images/hackmd/BJDxlOIG-l.png)
...
![截圖 2025-12-10 中午12.19.30](/images/hackmd/SJaCNuIz-g.png)
...
![截圖 2025-12-10 中午12.22.49](/images/hackmd/SJ4jrOLGWl.png)
...
![截圖 2025-12-10 中午12.29.28](/images/hackmd/ByE4PuLMbe.png)
...
![截圖 2025-12-10 中午12.28.49](/images/hackmd/Bk6ZvdIMZl.png)
...
#### DHCP
![截圖 2025-12-10 下午1.19.22](/images/hackmd/ryY17K8f-e.png)
...
![截圖 2025-12-10 下午1.17.58](/images/hackmd/Bkl9ztIMbl.png)
...
![截圖 2025-12-10 下午1.30.35](/images/hackmd/SJqFBFLfZe.png)

在 normal 情況下我們可以把 routing 存起來，告訴 internet 把 $\texttt{200.23.16.0/20}$ 全都傳給我

![截圖 2025-12-10 下午1.25.55](/images/hackmd/By6vVFIGWg.png)
...
![截圖 2025-12-10 下午1.26.21](/images/hackmd/BJPtEt8fZl.png)
...
![截圖 2025-12-11 凌晨2.08.24](/images/hackmd/Sy7QvVwM-x.png)
...
![截圖 2025-12-11 下午2.58.13](/images/hackmd/HkZ5ikdGbx.png)
...
![截圖 2025-12-11 下午3.04.46](/images/hackmd/H1jMpk_z-x.png)
...
![截圖 2025-12-11 下午3.14.21](/images/hackmd/BJKL1gdGbg.png)
