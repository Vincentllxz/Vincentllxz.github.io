...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/routing-1.png" style="width: 100%;" />
  <br />
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/routing-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Routing 2
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/service-model.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Service model
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/router-architecture.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Router Architecture
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/destination-based-forwarding-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
- Switching via **Memory**
    ...
    <div style="text-align: center;">
      <img src="/images/cn/ch04-data-plane/switching-fabrics-2.png" style="width: 100%;" />
      <br />
      <span style="color: grey; font-size: 16px;">
         Switching fabrics 2
      </span>
...
- Switching via **Bus**
    ...
    - 限制就變成 bus 的頻寬
    <div style="text-align: center;">
      <img src="/images/cn/ch04-data-plane/switching-fabrics-3.png" style="width: 100%;" />
      <br />
      <span style="color: grey; font-size: 16px;">
         Switching fabrics 3
      </span>
...
- Switching via **Interconnection Network**
    ...
    <div style="text-align: center;">
      <img src="/images/cn/ch04-data-plane/switching-fabrics-4.png" style="width: 100%;" />
      <br />
      <span style="color: grey; font-size: 16px;">
         Switching fabrics 4
      </span>
    ...
    <div style="text-align: center;">
      <img src="/images/cn/ch04-data-plane/switching-fabrics-5.png" style="width: 100%;" />
      <br />
      <span style="color: grey; font-size: 16px;">
         Switching fabrics 5
      </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/input-port-queue.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Input Port Queue
  </span>
...
- **Packet Scheduling** 要決定誰先執行
    ...
    <div style="text-align: center;">
      <img src="/images/cn/ch04-data-plane/output-port-queue-2.png" style="width: 100%;" />
      <br />
      <span style="color: grey; font-size: 16px;">
         Output Port Queue 2
      </span>
    ...
    - **Priority**
    <div style="text-align: center;">
      <img src="/images/cn/ch04-data-plane/output-port-queue-3.png" style="width: 100%;" />
      <br />
      <span style="color: grey; font-size: 16px;">
         Output Port Queue 3
      </span>
        ...
        <div style="text-align: center;">
          <img src="/images/cn/ch04-data-plane/output-port-queue-4.png" style="width: 100%;" />
          <br />
          <span style="color: grey; font-size: 16px;">
             Output Port Queue 4
          </span>
    ...
    <div style="text-align: center;">
      <img src="/images/cn/ch04-data-plane/output-port-queue-5.png" style="width: 100%;" />
      <br />
      <span style="color: grey; font-size: 16px;">
         Output Port Queue 5
      </span>
    ...
    <div style="text-align: center;">
      <img src="/images/cn/ch04-data-plane/output-port-queue-6.png" style="width: 100%;" />
      <br />
      <span style="color: grey; font-size: 16px;">
         Output Port Queue 6
      </span>
...
以下是當代的 IP header 架構
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/ip.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     IP
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/fragment-reassemble-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/fragment-reassemble-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/ip-addressing.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     IP addressing
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/subnets.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Subnets
  </span>
...
#### DHCP
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/dhcp-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     DHCP 1
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/dhcp-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     DHCP 2
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/hierarchical-addressing-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/hierarchical-addressing-3.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/nat.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     NAT
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/ipv6-format.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     IPv6 format
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/tunneling.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Tunneling
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch04-data-plane/forwarding.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Forwarding
  </span>
