...
<Fig src="/images/cn/ch04-data-plane/routing-1.webp" caption="Routing 1" />
- 用統一的 distributed algorithm，router 之間的 algorithm 互相溝通形成 forwarding table
2. **Software-Defined Networking(SDN)**
<Fig src="/images/cn/ch04-data-plane/routing-2.webp" caption="Routing 2" />
...
<Fig src="/images/cn/ch04-data-plane/service-model.webp" caption="Service model" />
...
<Fig src="/images/cn/ch04-data-plane/router-architecture.webp" caption="Router Architecture" />
...
<Fig src="/images/cn/ch04-data-plane/input-port.png" caption="Input port" />
...
<Fig src="/images/cn/ch04-data-plane/destination-based-forwarding-1.png" caption="Destination-based forwarding 1" />
...
<Fig src="/images/cn/ch04-data-plane/destination-based-forwarding-2.webp" caption="Destination-based forwarding 2" />
對於這個 table
...
<Fig src="/images/cn/ch04-data-plane/switching-fabrics-1.png" caption="Switching fabrics 1" />

- Switching via **Memory**
    - First generation Routers
    - 這種 switching 就是另一種普通 I/O 而已
    <Fig src="/images/cn/ch04-data-plane/switching-fabrics-2.webp" caption="Switching fabrics 2" />
- Switching via **Bus**
    - 從 input 輸入後，經由 bus connection 不經過 memory 直接前往 output
    - 限制就變成 bus 的頻寬
    <Fig src="/images/cn/ch04-data-plane/switching-fabrics-3.webp" caption="Switching fabrics 3" />
- Switching via **Interconnection Network**
    - 本來是設計給 multiprocessor 用的一種傳輸方法
    - 通常不會用上面的形式，而是用 **multi-stage** 的形式
    <Fig src="/images/cn/ch04-data-plane/switching-fabrics-4.webp" caption="Switching fabrics 4" />
    - $8 \times 8$ 的設計但只需要 4 個中繼點就好了
    - 我們通常會想用 parellel 的形式去做傳送，可以讓速度大幅增加
    <Fig src="/images/cn/ch04-data-plane/switching-fabrics-5.webp" caption="Switching fabrics 5" />
...
<Fig src="/images/cn/ch04-data-plane/input-port-queue.webp" caption="Input Port Queue" />
...
<Fig src="/images/cn/ch04-data-plane/output-port-queue-1.png" caption="Output Port Queue 1" />
...
- **Packet Scheduling** 要決定誰先執行
    ...
    <Fig src="/images/cn/ch04-data-plane/output-port-queue-2.webp" caption="Output Port Queue 2" />
        - 就是種最基本的 FIFO 結構
    - **Priority**
    <Fig src="/images/cn/ch04-data-plane/output-port-queue-3.webp" caption="Output Port Queue 3" />
        - 會根據 ISP 的 Priority 去做分配，如果 packet prioty 高就會被存在 high priority queue
        <Fig src="/images/cn/ch04-data-plane/output-port-queue-4.webp" caption="Output Port Queue 4" />
        - 雖然 packet 2 比 packet 3 還早到，但他們在 packet 1 處理完成的時候都已經進入 queue，所以會優先執行 high priority 的
    - **Round Robin** (RR) scheduling
    <Fig src="/images/cn/ch04-data-plane/output-port-queue-5.webp" caption="Output Port Queue 5" />
        - 一樣分成多個 queue，但這次執行順序是輪流，每個 queue equally 的輪流執行
    - **Weighted Fair Queuing (WFQ)**
    <Fig src="/images/cn/ch04-data-plane/output-port-queue-6.webp" caption="Output Port Queue 6" />
...
以下是當代的 IP header 架構
<Fig src="/images/cn/ch04-data-plane/ip.webp" caption="IP" />
...
<Fig src="/images/cn/ch04-data-plane/fragment-reassemble-1.webp" caption="Fragment, Reassemble 1" />
...
<Fig src="/images/cn/ch04-data-plane/fragment-reassemble-2.webp" caption="Fragment, Reassemble 2" />
...
<Fig src="/images/cn/ch04-data-plane/ip-addressing.webp" caption="IP addressing" />
...
<Fig src="/images/cn/ch04-data-plane/subnets.webp" caption="Subnets" />
...
#### DHCP
<Fig src="/images/cn/ch04-data-plane/dhcp-1.webp" caption="DHCP 1" />
...
<Fig src="/images/cn/ch04-data-plane/dhcp-2.webp" caption="DHCP 2" />
...
<Fig src="/images/cn/ch04-data-plane/hierarchical-addressing-1.png" caption="Hierarchical addressing 1" />

在 normal 情況下我們可以把 routing 存起來，告訴 internet 把 $\texttt{200.23.16.0/20}$ 全都傳給我

<Fig src="/images/cn/ch04-data-plane/hierarchical-addressing-2.webp" caption="Hierarchical addressing 2" />
...
<Fig src="/images/cn/ch04-data-plane/hierarchical-addressing-3.webp" caption="Hierarchical addressing 3" />
...
<Fig src="/images/cn/ch04-data-plane/nat.webp" caption="NAT" />
...
<Fig src="/images/cn/ch04-data-plane/ipv6-format.webp" caption="IPv6 format" />
...
<Fig src="/images/cn/ch04-data-plane/tunneling.webp" caption="Tunneling" />
...
<Fig src="/images/cn/ch04-data-plane/forwarding.webp" caption="Forwarding" />
