...
<Fig src="/images/cn/ch03-transport/transport-layer-action-1.webp" caption="Transport Layer action 1" />
- **Receiver**: Check header value，然後 Demultiplex message 到正確的 process
<Fig src="/images/cn/ch03-transport/transport-layer-action-2.webp" caption="Transport Layer action 2" />
...
<Fig src="/images/cn/ch03-transport/multiplexing-and-demultiplexing-1.webp" caption="Multiplexing &amp; Demultiplexing 1" />
- **demultiplexing**: 解讀 header 傳送到正確的 socket
<Fig src="/images/cn/ch03-transport/multiplexing-and-demultiplexing-2.webp" caption="Multiplexing &amp; Demultiplexing 2" />


### Multiplexing & Demultiplexing for UDP
- header 的架構必須有這些東西
<Fig src="/images/cn/ch03-transport/multiplexing-and-demultiplexing-for-udp-1.webp" caption="Multiplexing &amp; Demultiplexing for UDP 1" />
...
<Fig src="/images/cn/ch03-transport/multiplexing-and-demultiplexing-for-udp-2.webp" caption="Multiplexing &amp; Demultiplexing for UDP 2" />
...
- 一樣交換兩端資訊即可送回
<Fig src="/images/cn/ch03-transport/multiplexing-and-demultiplexing-for-tcp.webp" caption="Multiplexing &amp; Demultiplexing for TCP" />
...
<Fig src="/images/cn/ch03-transport/use-of-udp-1.webp" caption="Use of UDP 1" />
   <Fig src="/images/cn/ch03-transport/use-of-udp-2.webp" caption="Use of UDP 2" />
</Aside>
...
- **Checksum**
<Fig src="/images/cn/ch03-transport/udp-structure.webp" caption="UDP structure" />
...
- 做 complement 
<Fig src="/images/cn/ch03-transport/udp-check-sum-1.webp" caption="UDP Check Sum 1" />
</Aside>

<Aside type="caution" title="Checksum is a WEAK PROTECTION">
- 在這個例子裡 Checksum 沒變但裡面被 flip 了
<Fig src="/images/cn/ch03-transport/udp-check-sum-2.webp" caption="UDP Check Sum 2" />
</Aside>

## Reliable Data Transfer (RDT)
我們想像中是左圖，但實際上是右邊，並沒有真正的 reliable channel  
<Fig src="/images/cn/ch03-transport/reliable-data-transfer-1.webp" caption="Reliable Data Transfer 1" />
- 要考慮非常複雜的狀況，要站在另外一端的角度思考會發生什麼事情
    - 要設計出一對這樣的 protocol 而且要可以雙向溝通
- 實際上的 interface 其實長這樣
<Fig src="/images/cn/ch03-transport/reliable-data-transfer-2.webp" caption="Reliable Data Transfer 2" />
- 我們後面都用這種形式來表示狀態轉移
<Fig src="/images/cn/ch03-transport/reliable-data-transfer-3.webp" caption="Reliable Data Transfer 3" />
...
<Fig src="/images/cn/ch03-transport/rdt-1-0-reliable-transfer-with-reliable-channel.webp" caption="rdt 1.0: Reliable transfer with Reliable channel" />
...
- 上述過程可以畫成這個 FSM 
<Fig src="/images/cn/ch03-transport/rdt-2-0-channel-with-bits-error.webp" caption="rdt 2.0: Channel with bits error" />
...
<Fig src="/images/cn/ch03-transport/rdt-2-1-handling-garble-acks-naks-1.webp" caption="rdt 2.1: Handling Garble ACKs/NAKs 1" />
- **Receiver**:
    - 當收到並非自己 sequence number 的時候，也要在原地等待，並且送出 `ACKs` 的資訊
    - 要檢查是否是自己的 sequence number
<Fig src="/images/cn/ch03-transport/rdt-2-1-handling-garble-acks-naks-2.webp" caption="rdt 2.1: Handling Garble ACKs/NAKs 2" />

### rdt 2.2: Free NAKs Protocol
- 其實 `NAK` 可以用 `udt_send()` 非自己 sequence number 來取代
- 可以簡化 FSM 成
<Fig src="/images/cn/ch03-transport/rdt-2-2-free-naks-protocol.webp" caption="rdt 2.2: Free NAKs Protocol" />
...
- 要有 timeout checker 來檢查是否超過時間，超過則重新發送 pkt
   <Fig src="/images/cn/ch03-transport/rdt-3-0-channels-with-errors-and-loss.webp" caption="rdt 3.0 channels with errors and loss" />
   - `star_timer` 於發送 pkt 開始計算
   - `stop_timer` 於 `is_ACK()` 發送 

#### Action of rdt 3.0
<Fig src="/images/cn/ch03-transport/action-of-rdt-3-0-1.webp" caption="Action of rdt 3.0 1" />
<Fig src="/images/cn/ch03-transport/action-of-rdt-3-0-2.webp" caption="Action of rdt 3.0 2" />
- **Case (a)**: No loss
- **Case (b)**: `pkt` loss 
...
$$
<Fig src="/images/cn/ch03-transport/performance-of-rdt-3-0.webp" caption="Performance of rdt 3.0" />
...
- 允許一次多個 sequence number 的同時傳送
    ...
    - 需要更多 buffer space
<Fig src="/images/cn/ch03-transport/pipeline-1.webp" caption="Pipeline 1" />

<Aside type="tip" title="Example">
<Fig src="/images/cn/ch03-transport/pipeline-2.webp" caption="Pipeline 2" />
$$
...
**Sender**
<Fig src="/images/cn/ch03-transport/go-back-n-sender-receiver-1.webp" caption="Go-Back-N sender/receiver 1" />
上圖是一整串 `pkt`
- 名詞
    - 綠：已經被 `ACK`
    - 黃：送出但尚未 `ACK`
...
- FSM of Sender
    <Fig src="/images/cn/ch03-transport/go-back-n-sender-receiver-2.png" caption="Go-Back-N sender/receiver 2" />

**Receiver**
<Fig src="/images/cn/ch03-transport/go-back-n-sender-receiver-3.webp" caption="Go-Back-N sender/receiver 3" />
- 需要紀錄 `recv_base`，也就是下一個要收到的 **in-order** `pkt`
- 必須接收 in-order `pkt`，若遇到不是 `in-order` 就 discard，不停發送 `ACK(recv_base - 1)`

<Aside type="tip" title="Example">
<Fig src="/images/cn/ch03-transport/go-back-n-sender-receiver-4.webp" caption="Go-Back-N sender/receiver 4" />
...
<Fig src="/images/cn/ch03-transport/selective-repeat-1.webp" caption="Selective Repeat 1" />
...
<Aside type="tip" title="Example">
<Fig src="/images/cn/ch03-transport/selective-repeat-2.webp" caption="Selective Repeat 2" />
</Aside>

<Aside type="note" title="Dilemma of SR">
<Fig src="/images/cn/ch03-transport/selective-repeat-3.png" caption="Selective Repeat 3" />
...
<Fig src="/images/cn/ch03-transport/tcp-segment-structure.webp" caption="TCP segment structure" />
...
<Fig src="/images/cn/ch03-transport/tcp-seq-1.webp" caption="TCP seq \# 1" />

<Aside type="tip" title="Example">
<Fig src="/images/cn/ch03-transport/tcp-seq-2.webp" caption="TCP seq \# 2" />
...
$$
    ...
    - <Fig src="/images/cn/ch03-transport/timer.webp" caption="Timer" />
...
<Aside type="tip" title="Example">
<Fig src="/images/cn/ch03-transport/sender-event.webp" caption="Sender event" />
...
<Fig src="/images/cn/ch03-transport/fast-retransmit.webp" caption="fast retransmit" />
...
<Fig src="/images/cn/ch03-transport/tcp-flow-control.webp" caption="TCP Flow Control" />

### TCP connection managment
- **"handshake"** 要讓兩邊的 data sync 一下
    - initial, `rwnd`, 是否 accept, `seq #`
<Fig src="/images/cn/ch03-transport/tcp-connection-managment.webp" caption="TCP connection managment" />
...
<Fig src="/images/cn/ch03-transport/3-way-handshake-1.webp" caption="3-way handshake 1" />
1. server 關閉，但又建立了連線
2. dup data 的調整
</Aside>


<Fig src="/images/cn/ch03-transport/3-way-handshake-2.webp" caption="3-way handshake 2" />
...
- no-retransmission
<Fig src="/images/cn/ch03-transport/senario-1-1.webp" caption="Senario 1 1" />
<Fig src="/images/cn/ch03-transport/senario-1-2.webp" caption="Senario 1 2" />
...
<Fig src="/images/cn/ch03-transport/senario-2-1.webp" caption="Senario 2 1" />
<Fig src="/images/cn/ch03-transport/senario-2-2.webp" caption="Senario 2 2" />
- $\lambda'_\text{in}$ 傳送 $R/2$ 的資料但裡面有一些是重複無效資料，因此 $\lambda_\text{out}$ 達不到 $R/2$
<Fig src="/images/cn/ch03-transport/senario-2-3.webp" caption="Senario 2 3" />
...
<Fig src="/images/cn/ch03-transport/senario-3-1.webp" caption="Senario 3 1" />
<Fig src="/images/cn/ch03-transport/senario-3-2.webp" caption="Senario 3 2" />
...
- 出現 `loss` 後減少 sending rate 一半
    - 砍一半
<Fig src="/images/cn/ch03-transport/aimd.png" caption="AIMD" />
...
<Fig src="/images/cn/ch03-transport/tcp-congetion-window.png" caption="TCP congetion window" />
...
<Fig src="/images/cn/ch03-transport/tcp-slow-start.webp" caption="TCP slow start" />
...
<Fig src="/images/cn/ch03-transport/fsm-of-tcp-congestion-control.webp" caption="FSM of TCP congestion control" />
...
<Fig src="/images/cn/ch03-transport/explicit-congestion-notification.webp" caption="Explicit Congestion Notification" />
- 只有某些 TCP 才能做這件事
...
<Fig src="/images/cn/ch03-transport/tcp-fairness.png" caption="TCP Fairness" />
