...
![截圖 2025-10-22 上午10.07.10](/images/hackmd/BkoL23B0eg.png)
- **Receiver**: Check header value，然後 Demultiplex message 到正確的 process
![截圖 2025-10-22 上午10.10.26](/images/hackmd/HkkmTnr0xx.png)
...
![截圖 2025-10-22 上午11.21.03](/images/hackmd/Hkho6prAgg.png)
- **demultiplexing**: 解讀 header 傳送到正確的 socket
![截圖 2025-10-22 上午11.21.24](/images/hackmd/Hy166aBCxl.png)


### Multiplexing & Demultiplexing for UDP
- header 的架構必須有這些東西
![截圖 2025-10-22 上午11.23.24](/images/hackmd/SyzFRaHRxl.png =50%x)
...
![截圖 2025-10-22 上午11.27.53](/images/hackmd/BkBry0H0xx.png)
...
- 一樣交換兩端資訊即可送回
![截圖 2025-10-22 上午11.36.26](/images/hackmd/S1IHbABCxx.png)
...
![截圖 2025-10-22 上午11.50.42](/images/hackmd/B1ZiNASCee.png)
   ![截圖 2025-10-22 上午11.50.26](/images/hackmd/SykqECrAgl.png)
</Aside>
...
- **Checksum**
![截圖 2025-10-22 上午11.51.39](/images/hackmd/rydCVASAxg.png =50%x)
...
- 做 complement 
![截圖 2025-10-22 上午11.57.55](/images/hackmd/SyyLUCrCgl.png)
</Aside>

<Aside type="caution" title="Checksum is a WEAK PROTECTION">
- 在這個例子裡 Checksum 沒變但裡面被 flip 了
![截圖 2025-10-22 上午11.59.57](/images/hackmd/B12a8RHRgg.png)
</Aside>

## Reliable Data Transfer (RDT)
我們想像中是左圖，但實際上是右邊，並沒有真正的 reliable channel  
![截圖 2025-10-22 中午12.13.14](/images/hackmd/S1BkcRr0xg.png)
- 要考慮非常複雜的狀況，要站在另外一端的角度思考會發生什麼事情
    - 要設計出一對這樣的 protocol 而且要可以雙向溝通
- 實際上的 interface 其實長這樣
![截圖 2025-10-22 中午12.18.22](/images/hackmd/BkvEsASCgx.png)
- 我們後面都用這種形式來表示狀態轉移
![截圖 2025-10-22 中午12.21.29](/images/hackmd/S1VRoCBAel.png)
...
![截圖 2025-10-22 中午12.29.16](/images/hackmd/SJOipCBAex.png)
...
- 上述過程可以畫成這個 FSM 
![截圖 2025-10-22 中午12.35.41](/images/hackmd/HkhXyJ80lx.png)
...
![截圖 2025-10-22 中午12.41.08](/images/hackmd/HygOekU0xe.png)
- **Receiver**:
    - 當收到並非自己 sequence number 的時候，也要在原地等待，並且送出 `ACKs` 的資訊
    - 要檢查是否是自己的 sequence number
![截圖 2025-10-22 中午12.41.36](/images/hackmd/r1nFe18Ceg.png)

### rdt 2.2: Free NAKs Protocol
- 其實 `NAK` 可以用 `udt_send()` 非自己 sequence number 來取代
- 可以簡化 FSM 成
![截圖 2025-10-22 下午1.01.33](/images/hackmd/HkdVSk8Axe.png)
...
- 要有 timeout checker 來檢查是否超過時間，超過則重新發送 pkt
   ![截圖 2025-11-12 凌晨1.58.29](/images/hackmd/Sy-UteWg-e.png)
   - `star_timer` 於發送 pkt 開始計算
   - `stop_timer` 於 `is_ACK()` 發送 

#### Action of rdt 3.0
![截圖 2025-11-12 下午3.51.09](/images/hackmd/HyDPa3-lbl.png)
![截圖 2025-11-12 下午3.51.23](/images/hackmd/rkHD62-g-g.png)
- **Case (a)**: No loss
- **Case (b)**: `pkt` loss 
...
![截圖 2025-11-12 下午5.25.46](/images/hackmd/S1Esf0bx-l.png)
...
- 允許一次多個 sequence number 的同時傳送
    ...
    - 需要更多 buffer space
![截圖 2025-11-12 下午5.37.32](/images/hackmd/B1KwB0ZgWe.png)

<Aside type="tip" title="Example">
![截圖 2025-11-12 下午5.54.20](/images/hackmd/rJdIKR-eZx.png)
...
**Sender**
![截圖 2025-11-12 下午6.30.15](/images/hackmd/SJV6WJGlWe.png)
上圖是一整串 `pkt`
- 名詞
    - 綠：已經被 `ACK`
    - 黃：送出但尚未 `ACK`
...
- FSM of Sender
    ![截圖 2025-11-12 晚上7.04.46](/images/hackmd/Syh0Yyzlbe.png)

**Receiver**
![截圖 2025-11-13 凌晨1.30.04](/images/hackmd/S1L4ESfx-e.png)
- 需要紀錄 `recv_base`，也就是下一個要收到的 **in-order** `pkt`
- 必須接收 in-order `pkt`，若遇到不是 `in-order` 就 discard，不停發送 `ACK(recv_base - 1)`

<Aside type="tip" title="Example">
![截圖 2025-11-12 晚上7.05.27](/images/hackmd/BJM-qJMlWg.png)
...
![截圖 2025-11-13 下午1.51.12](/images/hackmd/HJJ1fg7eZx.png)
...
<Aside type="tip" title="Example">
![截圖 2025-11-13 下午3.19.21](/images/hackmd/ry4tIWXx-x.png)
</Aside>

<Aside type="note" title="Dilemma of SR">
![截圖 2025-11-13 下午4.22.08](/images/hackmd/SJiLHMQxWg.png)
...
![截圖 2025-11-13 晚上11.48.33](/images/hackmd/HyhC6OQgWx.png)
...
![截圖 2025-11-14 凌晨12.02.09](/images/hackmd/HJnWWFXlZg.png)

<Aside type="tip" title="Example">
![截圖 2025-11-14 凌晨12.03.52](/images/hackmd/S1zdZtQeWe.png)
...
$$\text{EstimatedRTT} = (1-\alpha)*\text{EstimatedRTT} + \alpha \times \text{SampleRTT}$$
    ...
    - ![截圖 2025-11-14 凌晨12.12.41](/images/hackmd/HkNYmFme-e.png)
...
<Aside type="tip" title="Example">
![截圖 2025-11-14 凌晨12.49.36](/images/hackmd/rJamhYXlZg.png)
...
![截圖 2025-11-14 凌晨1.36.48](/images/hackmd/r1qEP5XgZx.png)
...
![截圖 2025-11-14 凌晨1.43.49](/images/hackmd/BygJKqXxWl.png)

### TCP connection managment
- **"handshake"** 要讓兩邊的 data sync 一下
    - initial, `rwnd`, 是否 accept, `seq #`
![截圖 2025-11-14 凌晨1.49.31](/images/hackmd/H1LV597e-g.png)
...
![截圖 2025-11-14 凌晨1.56.01](/images/hackmd/B10ns5QxWl.png)
1. server 關閉，但又建立了連線
2. dup data 的調整
</Aside>


![截圖 2025-11-14 凌晨1.57.26](/images/hackmd/BJlM29ml-e.png)
...
- no-retransmission
![截圖 2025-11-14 凌晨2.09.07](/images/hackmd/SkLRCcQxZx.png)
![截圖 2025-11-14 凌晨2.13.12](/images/hackmd/SyDakoQlWe.png)
...
![截圖 2025-11-14 凌晨2.25.51](/images/hackmd/Bk2hzjXgbx.png)
![截圖 2025-11-14 凌晨2.28.36](/images/hackmd/H1gDXime-l.png)
- $\lambda'_\text{in}$ 傳送 $R/2$ 的資料但裡面有一些是重複無效資料，因此 $\lambda_\text{out}$ 達不到 $R/2$
![截圖 2025-11-14 凌晨2.33.26](/images/hackmd/H1HFEimeZx.png)
...
![截圖 2025-11-14 凌晨2.38.01](/images/hackmd/ryZsBjmgWe.png)
![截圖 2025-11-14 凌晨2.39.49](/images/hackmd/BJMbIsmebg.png)
...
- 出現 `loss` 後減少 sending rate 一半
    - 砍一半
![截圖 2025-11-14 下午3.42.52](/images/hackmd/ryKtaLNgWx.png)
...
![截圖 2025-11-14 下午3.53.00](/images/hackmd/Bk5ygDExbl.png)
...
![截圖 2025-11-14 下午4.07.33](/images/hackmd/SkG8XPNlWe.png)
...
![截圖 2025-11-14 下午4.15.33](/images/hackmd/SkTVrPEe-g.png)
...
![截圖 2025-11-19 下午2.35.40](/images/hackmd/r18HrJjgZe.png)
- 只有某些 TCP 才能做這件事
...
![截圖 2025-11-19 下午2.43.25](/images/hackmd/HkdMDysgbl.png)
