...
![figure](/images/cn/ch02-app/fig.png =60%x)
</Aside>
...
- **Security**
- 以下是常見服務隊各種屬性的要求
![Available in Transport Layer](/images/cn/ch02-app/available-in-transport-layer.png)
...
- 大致結構如下
  ...
  ![HTTP Request message](/images/cn/ch02-app/http-request-message.png)
...
![Cookie](/images/cn/ch02-app/cookie.png)
...
![Web Caches 1](/images/cn/ch02-app/web-caches-1.png)
...
![Web Caches 2](/images/cn/ch02-app/web-caches-2.png)
...
- 會進行以下機制，自動排除寄送 `304 Not Modified`
  ...
  ![Conditional GET](/images/cn/ch02-app/conditional-get.png)


### HTTP/2
- 把資料分解成 frame 去做 HOL Blocking
- 如果 $O_1$ 必須一起送出，那 $O_2 \to O_4$ 會 delay 非常嚴重，但分段就可以讓 delay 只存在 $O_1$
- ![HTTP/2](/images/cn/ch02-app/http-2.png)
...
![Email, SMTP 1](/images/cn/ch02-app/email-smtp-1.png)
...
![Email, SMTP 2](/images/cn/ch02-app/email-smtp-2.png)
...
![A Distributed, Hierarchical Database](/images/cn/ch02-app/a-distributed-hierarchical-database.png)
...
![Iterated Query](/images/cn/ch02-app/iterated-query.png)

### Recursive Query
- 同樣一層一層訪問，但不用每次都回到 local DNS server
![Recursive Query](/images/cn/ch02-app/recursive-query.png)
...
![DNS protocol message 1](/images/cn/ch02-app/dns-protocol-message-1.png)
![DNS protocol message 2](/images/cn/ch02-app/dns-protocol-message-2.png)

## P2P
![P2P 1](/images/cn/ch02-app/p2p-1.png)
...
![P2P 2](/images/cn/ch02-app/p2p-2.png)
...
![Video Stream & CDN 1](/images/cn/ch02-app/video-stream-and-cdn-1.png)
- 並不是下載整個影片檔，而是 server 邊送我邊看，因此稱作 streaming
</Aside>

<Aside type="note" title="Playout Buffering">
![Video Stream & CDN 2](/images/cn/ch02-app/video-stream-and-cdn-2.png)
...
![CDN](/images/cn/ch02-app/cdn.png)
