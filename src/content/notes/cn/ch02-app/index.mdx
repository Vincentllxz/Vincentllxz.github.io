...
![截圖 2025-10-22 凌晨1.56.54](/images/hackmd/Hk4_trBAxl.png =60%x)
</Aside>
...
- **Security**
- 以下是常見服務隊各種屬性的要求
![截圖 2025-10-22 凌晨2.34.49](/images/hackmd/B1SLfLHAeg.png)
...
- 大致結構如下
  ...
  ![截圖 2025-10-22 凌晨2.53.10](/images/hackmd/Bk7oILSCgx.png)
...
![截圖 2025-10-22 凌晨3.03.24](/images/hackmd/BJdWtUBAee.png)
...
![截圖 2025-10-22 凌晨3.23.53](/images/hackmd/BkUR6LSClx.png)
...
![截圖 2025-10-22 凌晨3.32.33](/images/hackmd/rkxkxPSRxl.png)
...
- 會進行以下機制，自動排除寄送 `304 Not Modified`
  ...
  ![截圖 2025-10-22 凌晨3.41.49](/images/hackmd/ByY-MvS0ee.png)


### HTTP/2
- 把資料分解成 frame 去做 HOL Blocking
- 如果 $O_1$ 必須一起送出，那 $O_2 \to O_4$ 會 delay 非常嚴重，但分段就可以讓 delay 只存在 $O_1$
- ![截圖 2025-10-22 凌晨3.47.00](/images/hackmd/S1bHQwHCxx.png)
...
![截圖 2025-10-22 凌晨3.49.37](/images/hackmd/rkCCmPSAgg.png)
...
![截圖 2025-10-22 凌晨3.53.01](/images/hackmd/Hk_oVPSRge.png)
...
![截圖 2025-10-22 凌晨4.07.57](/images/hackmd/rJtX_DHCex.png)
...
![截圖 2025-10-22 凌晨4.14.35](/images/hackmd/SJdhYvHAll.png)

### Recursive Query
- 同樣一層一層訪問，但不用每次都回到 local DNS server
![截圖 2025-10-22 凌晨4.15.54](/images/hackmd/Sk8W5vSCeg.png)
...
![截圖 2025-10-22 凌晨4.26.18](/images/hackmd/BJU_2vHRlg.png)
![截圖 2025-10-22 凌晨4.26.01](/images/hackmd/BJBw3wSCel.png)

## P2P
![截圖 2025-10-22 凌晨4.34.08](/images/hackmd/SJCS0PrAxe.png)
...
![截圖 2025-10-22 凌晨4.39.08](/images/hackmd/H19u1_BRel.png)
...
![截圖 2025-10-22 上午8.50.49](/images/hackmd/rk4O5irAxx.png)
- 並不是下載整個影片檔，而是 server 邊送我邊看，因此稱作 streaming
</Aside>

<Aside type="note" title="Playout Buffering">
![截圖 2025-10-22 上午8.55.06](/images/hackmd/BkI_oiBCeg.png)
...
![截圖 2025-10-22 上午9.48.46](/images/hackmd/Bkcf_3BAex.png)
