...
<Fig src="/images/cn/ch02-app/fig.webp" caption="figure" />
</Aside>
...
- **Security**
- 以下是常見服務隊各種屬性的要求
<Fig src="/images/cn/ch02-app/available-in-transport-layer.webp" caption="Available in Transport Layer" />
...
- 大致結構如下
  ...
  <Fig src="/images/cn/ch02-app/http-request-message.webp" caption="HTTP Request message" />
...
<Fig src="/images/cn/ch02-app/cookie.webp" caption="Cookie" />
...
<Fig src="/images/cn/ch02-app/web-caches-1.webp" caption="Web Caches 1" />
...
<Fig src="/images/cn/ch02-app/web-caches-2.webp" caption="Web Caches 2" />
...
- 會進行以下機制，自動排除寄送 `304 Not Modified`
  ...
  <Fig src="/images/cn/ch02-app/conditional-get.webp" caption="Conditional GET" />


### HTTP/2
- 把資料分解成 frame 去做 HOL Blocking
- 如果 $O_1$ 必須一起送出，那 $O_2 \to O_4$ 會 delay 非常嚴重，但分段就可以讓 delay 只存在 $O_1$
- <Fig src="/images/cn/ch02-app/http-2.webp" caption="HTTP/2" />
...
<Fig src="/images/cn/ch02-app/email-smtp-1.webp" caption="Email, SMTP 1" />
...
<Fig src="/images/cn/ch02-app/email-smtp-2.webp" caption="Email, SMTP 2" />
...
<Fig src="/images/cn/ch02-app/a-distributed-hierarchical-database.webp" caption="A Distributed, Hierarchical Database" />
...
<Fig src="/images/cn/ch02-app/iterated-query.webp" caption="Iterated Query" />

### Recursive Query
- 同樣一層一層訪問，但不用每次都回到 local DNS server
<Fig src="/images/cn/ch02-app/recursive-query.webp" caption="Recursive Query" />
...
<Fig src="/images/cn/ch02-app/dns-protocol-message-1.webp" caption="DNS protocol message 1" />
<Fig src="/images/cn/ch02-app/dns-protocol-message-2.webp" caption="DNS protocol message 2" />

## P2P
<Fig src="/images/cn/ch02-app/p2p-1.webp" caption="P2P 1" />
...
<Fig src="/images/cn/ch02-app/p2p-2.webp" caption="P2P 2" />
...
<Fig src="/images/cn/ch02-app/video-stream-and-cdn-1.webp" caption="Video Stream &amp; CDN 1" />
- 並不是下載整個影片檔，而是 server 邊送我邊看，因此稱作 streaming
</Aside>

<Aside type="note" title="Playout Buffering">
<Fig src="/images/cn/ch02-app/video-stream-and-cdn-2.webp" caption="Video Stream &amp; CDN 2" />
...
<Fig src="/images/cn/ch02-app/cdn.webp" caption="CDN" />
