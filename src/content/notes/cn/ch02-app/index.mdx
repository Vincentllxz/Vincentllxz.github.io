...
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/fig.png" style="width: 60%;" />
  <br />
...
- 以下是常見服務隊各種屬性的要求
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/available-in-transport-layer.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Available in Transport Layer
  </span>
...
- 大致結構如下
  ...
  <div style="text-align: center;">
    <img src="/images/cn/ch02-app/http-request-message.png" style="width: 100%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
       HTTP Request message
    </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/cookie.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Cookie
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/web-caches-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Web Caches 1
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/web-caches-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Web Caches 2
  </span>
...
- 會進行以下機制，自動排除寄送 `304 Not Modified`
  ...
  <div style="text-align: center;">
    <img src="/images/cn/ch02-app/conditional-get.png" style="width: 100%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
       Conditional GET
    </span>
...
- <div style="text-align: center;">
    <img src="/images/cn/ch02-app/http-2.png" style="width: 100%;" />
    <br />
    <span style="color: grey; font-size: 16px;">
       HTTP/2
    </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/email-smtp-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Email, SMTP 1
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/email-smtp-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Email, SMTP 2
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/a-distributed-hierarchical-database.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     A Distributed, Hierarchical Database
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/iterated-query.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Iterated Query
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/recursive-query.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Recursive Query
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/dns-protocol-message-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/dns-protocol-message-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
## P2P
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/p2p-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     P2P 1
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/p2p-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     P2P 2
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/video-stream-and-cdn-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Video Stream &amp; CDN 1
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/video-stream-and-cdn-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Video Stream &amp; CDN 2
  </span>
...
<div style="text-align: center;">
  <img src="/images/cn/ch02-app/cdn.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     CDN
  </span>
