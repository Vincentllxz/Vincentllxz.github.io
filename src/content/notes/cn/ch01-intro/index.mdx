...
![截圖 2025-10-21 晚上9.04.11](/images/hackmd/B18CEWHCxg.png)
...
- Guarantee 一定有完整的一條 path 上面不會有其他人（圖例：四條中保證一條為空）
    - 如果你那段沒有用到，其他人也不能用
    - Inefficient
    - ![截圖 2025-10-21 晚上9.13.02](/images/hackmd/rJO1PWBAel.png =80%x)


### FDM vs TDM
- **FDM**
    - 完整使用那個頻段
    ![截圖 2025-10-21 晚上9.14.32](/images/hackmd/BJESDWHCgl.png)
-**TDM**
    - Sharing，但頻寬 (bandwidth) 大，只要在自己的 time slot 都可以用
    - ![截圖 2025-10-21 晚上9.15.45](/images/hackmd/r1sFPWBRge.png)

<Aside type="tip" title="Example">
![截圖 2025-10-21 晚上9.16.54](/images/hackmd/SklRwZHCxe.png)
...
![截圖 2025-10-21 晚上9.32.19](/images/hackmd/rkl_i-HCll.png)


- **Tier-1**: Commercial ISPs (National or International)

![截圖 2025-10-21 晚上9.40.15](/images/hackmd/SkcSTWBAel.png)

## Performance
也就是分析各種 delay 來源

### Packet delay
![截圖 2025-10-21 晚上9.50.14](/images/hackmd/HJbiyfSRlg.png)
...
![截圖 2025-10-21 晚上10.19.33](/images/hackmd/BybYIMS0xg.png)
- 在一條正常的網路裡 Bottleneck link 為 $\ell_B$
$$
\ell_B = \arg \min_{i\ \in\ \{1,2,...,n\}} R_i
$$
![截圖 2025-10-21 晚上10.25.34](/images/hackmd/SJ9JdfrRge.png)
    - 而他的速率就是 $R_B$
$$
...
$$
![截圖 2025-10-21 晚上10.30.34](/images/hackmd/S1IGYGHCgx.png =60%x)
...
![截圖 2025-10-22 凌晨1.34.33](/images/hackmd/ryKVNHrRle.png)
...
![截圖 2025-10-22 凌晨1.43.49](/images/hackmd/rJ-vLrrCgl.png)
- Wireshark 就是一款免費的 packet-sniffer

### IP Snoofing
- 對 packet 進行操作，此處 C 假裝自己 send 的 packet 是 B 來的
![截圖 2025-10-22 凌晨1.45.34](/images/hackmd/SycaUHHAlg.png)
