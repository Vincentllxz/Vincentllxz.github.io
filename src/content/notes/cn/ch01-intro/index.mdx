...
![Packet-switching](/images/cn/ch01-intro/packet-switching.png)
...
- Guarantee 一定有完整的一條 path 上面不會有其他人（圖例：四條中保證一條為空）
    - 如果你那段沒有用到，其他人也不能用
    - Inefficient
    - ![Circuit-switching](/images/cn/ch01-intro/circuit-switching.png =80%x)


### FDM vs TDM
- **FDM**
    - 完整使用那個頻段
    ![FDM vs TDM 1](/images/cn/ch01-intro/fdm-vs-tdm-1.png)
-**TDM**
    - Sharing，但頻寬 (bandwidth) 大，只要在自己的 time slot 都可以用
    - ![FDM vs TDM 2](/images/cn/ch01-intro/fdm-vs-tdm-2.png)

<Aside type="tip" title="Example">
![FDM vs TDM 3](/images/cn/ch01-intro/fdm-vs-tdm-3.png)
...
![Structure 1](/images/cn/ch01-intro/structure-1.png)


- **Tier-1**: Commercial ISPs (National or International)

![Structure 2](/images/cn/ch01-intro/structure-2.png)

## Performance
也就是分析各種 delay 來源

### Packet delay
![Packet delay](/images/cn/ch01-intro/packet-delay.png)
...
![Throughput 1](/images/cn/ch01-intro/throughput-1.png)
- 在一條正常的網路裡 Bottleneck link 為 $\ell_B$
$$
\ell_B = \arg \min_{i\ \in\ \{1,2,...,n\}} R_i
$$
![Throughput 2](/images/cn/ch01-intro/throughput-2.png)
    - 而他的速率就是 $R_B$
$$
...
$$
![Throughput 3](/images/cn/ch01-intro/throughput-3.png =60%x)
...
![Services, Layering, Encapsulation](/images/cn/ch01-intro/services-layering-encapsulation.png)
...
![Packet "sniffing"](/images/cn/ch01-intro/packet-sniffing.png)
- Wireshark 就是一款免費的 packet-sniffer

### IP Snoofing
- 對 packet 進行操作，此處 C 假裝自己 send 的 packet 是 B 來的
![IP Snoofing](/images/cn/ch01-intro/ip-snoofing.png)
