...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch01-intro/overview.webp" style="width: 100%;" />
  <br />
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch01-intro/computer-system-organization.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Computer-System Organization
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch01-intro/interrupt-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Interrupt 1
  </span>
...
2. 存下剛剛停下的地方
3. 執行 ISR (Interrupt service routine)
4. CPU 回覆原始狀態

<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch01-intro/interrupt-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Interrupt 2
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch01-intro/interrupt-3.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Interrupt 3
  </span>
...
- 通常一個 Storage 讀寫速度越快就越小，而且 **Volatile**
- 會有成本問題
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch01-intro/secondary-and-tertiary-storage.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Secondary and Tertiary Storage
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch01-intro/direct-memory-access.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Direct Memory Access
  </span>
...
- Multiprocessor Systems
    - 在現今的系統內比較重要
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch01-intro/comuter-system-architecture.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Computer-System Architecture
  </span>
...
- **Mode bit**
    - 用 system call 做到更改
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch01-intro/dual-mode-and-multimode-operation.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Dual-Mode &amp; Multimode Operation
  </span>
...
## Virtualization
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch01-intro/virtualization.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Virtualization
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch01-intro/distributed-system.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Distributed System
  </span>
