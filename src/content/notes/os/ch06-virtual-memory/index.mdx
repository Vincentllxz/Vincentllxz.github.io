...
<Fig src="/images/os/ch06-virtual-memory/virtual-memory-2.webp" caption="Virtual Memory 2" />
...
<Fig src="/images/os/ch06-virtual-memory/virtual-memory-1.webp" />
...
<Fig src="/images/os/ch06-virtual-memory/shared-library.webp" />
...
<Fig src="/images/os/ch06-virtual-memory/basic-concept.webp" caption="Basic Concept" />
...
<Fig src="/images/os/ch06-virtual-memory/page-fault-handling-1.webp" caption="Page Fault Handling 1" />
...
<Fig src="/images/os/ch06-virtual-memory/page-fault-handling-2.webp" caption="Page Fault Handling 2" />


3. 在 Physical memory 裡面找到 **Free frame** (從 free frame list 找)
<Fig src="/images/os/ch06-virtual-memory/page-fault-handling-3.webp" caption="Page Fault Handling 3" />

4. 把那個 Page 放到 Memory 裡面
<Fig src="/images/os/ch06-virtual-memory/page-fault-handling-4.webp" caption="Page Fault Handling 4" />

5. 更新 Page table（invalid to valid）
<Fig src="/images/os/ch06-virtual-memory/page-fault-handling-5.webp" caption="Page Fault Handling 5" />

6. 重新 Restart 原本的 instruction
<Fig src="/images/os/ch06-virtual-memory/page-fault-handling-6.webp" caption="Page Fault Handling 6" />
...
<Fig src="/images/os/ch06-virtual-memory/instruction-restart.webp" caption="Instruction Restart" />
...
<Fig src="/images/os/ch06-virtual-memory/free-frame-list.webp" caption="Free-Frame List" />
...
<Fig src="/images/os/ch06-virtual-memory/copy-on-write.webp" caption="Copy-on-Write" />
...
<Fig src="/images/os/ch06-virtual-memory/page-replacement.webp" caption="Page Replacement" />
...
<Fig src="/images/os/ch06-virtual-memory/basic-page-replacement.webp" caption="Basic Page Replacement" />
...
<Fig src="/images/os/ch06-virtual-memory/fifo-page-replacement.webp" caption="FIFO Page Replacement" />
...
在 3~4 這邊反而回升了
<Fig src="/images/os/ch06-virtual-memory/belady-s-anomaly.webp" caption="Belady's Anomaly" />
...
<Fig src="/images/os/ch06-virtual-memory/optimal-page-replacement.webp" caption="Optimal Page Replacement" />
...
<Fig src="/images/os/ch06-virtual-memory/lru-page-replacement-2.webp" caption="LRU Page Replacement 2" />
...
<Fig src="/images/os/ch06-virtual-memory/lru-page-replacement-1.webp" />
...
<Fig src="/images/os/ch06-virtual-memory/second-chance-algorithm.webp" caption="Second-Chance Algorithm" />
...
<Fig src="/images/os/ch06-virtual-memory/reclaiming-pages.webp" />
...
<Fig src="/images/os/ch06-virtual-memory/non-uniform-memory-access.webp" />
...
<Fig src="/images/os/ch06-virtual-memory/cause-of-thrashing.webp" />
...
<Fig src="/images/os/ch06-virtual-memory/buddy-system.webp" />
...
<Fig src="/images/os/ch06-virtual-memory/slab-allocation.webp" />
...
<Fig src="/images/os/ch06-virtual-memory/solaris.webp" />
