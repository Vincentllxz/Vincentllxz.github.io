...
![Virtual Memory 2](/images/os/ch06-virtual-memory/virtual-memory-2.png)
...
![Basic Concept](/images/os/ch06-virtual-memory/basic-concept.png)
...
![Page Fault Handling 1](/images/os/ch06-virtual-memory/page-fault-handling-1.png)
...
![Page Fault Handling 2](/images/os/ch06-virtual-memory/page-fault-handling-2.png)


3. 在 Physical memory 裡面找到 **Free frame** (從 free frame list 找)
![Page Fault Handling 3](/images/os/ch06-virtual-memory/page-fault-handling-3.png)

4. 把那個 Page 放到 Memory 裡面
![Page Fault Handling 4](/images/os/ch06-virtual-memory/page-fault-handling-4.png)

5. 更新 Page table（invalid to valid）
![Page Fault Handling 5](/images/os/ch06-virtual-memory/page-fault-handling-5.png)

6. 重新 Restart 原本的 instruction
![Page Fault Handling 6](/images/os/ch06-virtual-memory/page-fault-handling-6.png)
...
![Instruction Restart](/images/os/ch06-virtual-memory/instruction-restart.png)
...
![Free-Frame List](/images/os/ch06-virtual-memory/free-frame-list.png)
...
![Copy-on-Write](/images/os/ch06-virtual-memory/copy-on-write.png)
...
![Page Replacement](/images/os/ch06-virtual-memory/page-replacement.png)
...
![Basic Page Replacement](/images/os/ch06-virtual-memory/basic-page-replacement.png)
...
![FIFO Page Replacement](/images/os/ch06-virtual-memory/fifo-page-replacement.png)
...
在 3~4 這邊反而回升了
![Belady's Anomaly](/images/os/ch06-virtual-memory/belady-s-anomaly.png)
...
![Optimal Page Replacement](/images/os/ch06-virtual-memory/optimal-page-replacement.png)
...
![LRU Page Replacement 2](/images/os/ch06-virtual-memory/lru-page-replacement-2.png)
...
![Second-Chance Algorithm](/images/os/ch06-virtual-memory/second-chance-algorithm.png)
