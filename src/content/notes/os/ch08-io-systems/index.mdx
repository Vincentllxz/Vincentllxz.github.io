...
<div style="text-align: center;">
  <img src="/images/os/ch08-io-systems/interrupt-vector.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Interrupt vector
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch08-io-systems/application-i-o-interface-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch08-io-systems/application-i-o-interface-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
- **Raw I/O**：跳過 File System, OS buffer cache，直接去控制 I/O device，(e.g., Database system 對 Disk 有更好的 Management)
- **Direct I/O**：透過 File System 操作檔案，但跳過 OS 的 [Buffer Cache / Page Cache](https://vinsong.csie.org/notes/os/ch11-file-system-implementation#buffer-cache-and-page-cache)，資料直接從 User-space 的 buffer 透過 DMA 寫入 Device，或是從 Device 直接讀取到 User-space 的 buffer，這樣就不會有兩份資料的 copy
