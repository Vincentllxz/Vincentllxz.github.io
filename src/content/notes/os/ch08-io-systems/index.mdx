...
<Fig src="/images/os/ch08-io-systems/typical-pc-bus-structure.webp" caption="Typical PC Bus Structure" />
...
<Fig src="/images/os/ch08-io-systems/memory-device.webp" caption="到對應的 Memory 讀寫等於完成對 Device 的控制" />
...
<Fig src="/images/os/ch08-io-systems/interrupt-driven-i-o-cycle.webp" caption="Interrupt-Driven I/O Cycle" />

Interrupt Routine 後才會把東西 CPU 使用權交回去給原本的 Process

<Fig src="/images/os/ch08-io-systems/interrupt-vector.webp" caption="Interrupt vector" />
...
<Fig src="/images/os/ch08-io-systems/dma-progress.webp" caption="DMA Progress" />
...
<Fig src="/images/os/ch08-io-systems/application-i-o-interface-1.webp" caption="Application I/O Interface structure" />

可以用以下的分類方法，有各種不同的限制

<Fig src="/images/os/ch08-io-systems/application-i-o-interface-2.webp" caption="Application I/O Interface types" />
...
<Fig src="/images/os/ch08-io-systems/example-of-i-o-scheduling.webp" caption="Example of I/O Scheduling" />
...
<Fig src="/images/os/ch08-io-systems/life-cycle-of-blocking-read-request-1.webp" caption="Life Cycle of Blocking Read Request" />

## STREAMS

這是在 Unix 系統中特有的結構，本質上就跟 Network 一樣，是用 Moduler 的結構化設計，User 跟 Device 之間有各自的 format 互相不會侵犯，是 layer 化設計的代表

<Fig src="/images/os/ch08-io-systems/life-cycle-of-blocking-read-request-2.webp" caption="Life Cycle of Blocking Read Request" />
...
<Fig src="/images/os/ch08-io-systems/intercomputer-communications.webp" caption="Intercomputer Communications" />
...
<Fig src="/images/os/ch08-io-systems/device-functionality-progression.webp" caption="Device Functionality Progression" />