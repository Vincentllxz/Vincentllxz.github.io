...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/cpu-schedule-concept.webp" style="width: 50%;" />
  <br />
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/histogram-of-cpu-burst-time.webp" style="width: 70%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/cpu-scheduler.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     CPU Scheduler
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/workflow-of-dispatcher.webp" style="width: 50%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/first-come-first-served-scheduling-1.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/first-come-first-served-scheduling-2.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
| **Burst Time**    | 6    | 8    |7 |3|
 ...
 <div style="text-align: center;">
   <img src="/images/os/ch07-cpu-scheduling/shortest-job-first-scheduling.webp" style="width: 100%;" />
   <br />
   <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/shortest-remaining-time-first-scheduling.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Shortest-Remaining-Time-First Scheduling
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/round-robin-scheduling.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/quantum-to-avg-turnaround-time.webp" style="width: 60%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/priority-scheduling.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Priority Scheduling
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/priority-scheduling-with-round-robin.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Priority Scheduling with Round-Robin
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/multilevel-queue-1.webp" style="width: 40%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Multilevel Queue 
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/multilevel-queue-scheduling.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Multilevel Queue Scheduling
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/multilevel-queue-2.webp" style="width: 50%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Multilevel Queue 
  </span>
...
- **Symmetric Multiprocessing (SMP)**: 每個 Processor 都是同等地位，每個 Processor 要自己去處理自己的 Schedule 問題，從 Queue 裡面拿出 task，可以分成兩種
    ...
    <div style="text-align: center;">
      <img src="/images/os/ch07-cpu-scheduling/share-queue.webp" style="width: 50%;" />
      <br />
      <span style="color: grey; font-size: 16px;">
         Share Queue 
      </span>
    ...
    <div style="text-align: center;">
      <img src="/images/os/ch07-cpu-scheduling/seperate-queue.webp" style="width: 50%;" />
      <br />
      <span style="color: grey; font-size: 16px;">
         Separate Queue
      </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/multicore-processors.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Multicore Processors
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/multithreaded-multicore-system.webp" style="width: 50%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/os-view-of-multithreaded-multicore-system.webp" style="width: 50%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/two-level-threading.webp" style="width: 50%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Two level Threading
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/numa-system.webp" style="width: 50%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/event-latency.webp" style="width: 50%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Event latency
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/interrupt-latency.webp" style="width: 70%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Interrupt Latency
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/dispatch-latency.webp" style="width: 80%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Dispatch Latency
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/periodic-process-require-cpu-at-constant-interva.webp" style="width: 80%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/example-of-rate-monotonic-scheduling.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/counter-example-of-rate-monotonic-scheduling.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/example-of-edf-scheduling.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/example-of-domain.webp" style="width: 50%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
      Example of domain
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/windows-scheduling.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Windows scheduling
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/solaris-scheduling.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Solaris scheduling
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/solaris-priority.webp" style="width: 50%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
      Solaris Priority
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/fcfs-28ms.webp" style="width: 80%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
      FCFS：28ms
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/nonpreemptive-sjf-13ms.webp" style="width: 80%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch07-cpu-scheduling/round-robin-23ms.webp" style="width: 80%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
      Round Robin：23ms
  </span>
