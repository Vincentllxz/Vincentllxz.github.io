...
<Fig src="/images/os/ch07-cpu-scheduling/cpu-schedule-concept.webp" caption="CPU Schedule Concept" />

我們通常會發現 CPU Burst time 都是非常短的，Distribution 偏小（跟網路封包一樣），根據他們的各自的使用時間，可以分成
- I/O Bound Program
- CPU Bound Program

<Fig src="/images/os/ch07-cpu-scheduling/histogram-of-cpu-burst-time.webp" caption="Histogram of CPU Burst time" />

### CPU Scheduler

<Aside type="caution" title="Recap Process State">

<Fig src="/images/os/ch07-cpu-scheduling/cpu-scheduler.webp" caption="CPU Scheduler" />
</Aside>
...
<Fig src="/images/os/ch07-cpu-scheduling/workflow-of-dispatcher.webp" caption="Workflow of Dispatcher" />
...
<Fig src="/images/os/ch07-cpu-scheduling/first-come-first-served-scheduling-1.webp" caption="First-Come, First-Served Scheduling 1" />
Waiting time 分別是 $P_1=0,\ P_2=24,\ P_3=27$, average 是 $\hat{t}=17$

- 接下來假設 arrival order 是 $P_2 \to P_3 \to P_1$ 會拿到
<Fig src="/images/os/ch07-cpu-scheduling/first-come-first-served-scheduling-2.webp" caption="First-Come, First-Served Scheduling 2" />
...
| **Burst Time**    | 6    | 8    |7 |3|
 ...
 <Fig src="/images/os/ch07-cpu-scheduling/shortest-job-first-scheduling.webp" caption="Shortest-Job-First Scheduling" />
...
<Fig src="/images/os/ch07-cpu-scheduling/shortest-remaining-time-first-scheduling.webp" caption="Shortest-Remaining-Time-First Scheduling" />
...
<Fig src="/images/os/ch07-cpu-scheduling/round-robin-scheduling.webp" caption="Round-Robin Scheduling" />
...
<Fig src="/images/os/ch07-cpu-scheduling/quantum-to-avg-turnaround-time.webp" caption="Quantum to Avg Turnaround Time" />
...
<Fig src="/images/os/ch07-cpu-scheduling/priority-scheduling.webp" caption="Priority Scheduling" />
...
<Fig src="/images/os/ch07-cpu-scheduling/priority-scheduling-with-round-robin.webp" caption="Priority Scheduling with Round-Robin" />

基本上就是先以 **Priority** 做排序，如果一樣就用 **Round Robin** 做輪換

### Multilevel Queue Scheduling

<Fig src="/images/os/ch07-cpu-scheduling/multilevel-queue-1.webp" caption="Multilevel Queue" />

一次直接選一整個 Queue，先執行最高 Priority 的 Queue

以下是一個真實案例，每個 Queue 可以有自己的 Schedule Algorithm

<Fig src="/images/os/ch07-cpu-scheduling/multilevel-queue-scheduling.webp" caption="Multilevel Queue Scheduling" />
...
<Fig src="/images/os/ch07-cpu-scheduling/multilevel-queue-2.webp" caption="Multilevel Queue" />
...
- **Symmetric Multiprocessing (SMP)**: 每個 Processor 都是同等地位，每個 Processor 要自己去處理自己的 Schedule 問題，從 Queue 裡面拿出 task，可以分成兩種
    ...
    <Fig src="/images/os/ch07-cpu-scheduling/share-queue.webp" caption="Share Queue" />
    
    - 分開 Queue，需要做 Load Balancing
    <Fig src="/images/os/ch07-cpu-scheduling/seperate-queue.webp" caption="Separate Queue" />
...
<Fig src="/images/os/ch07-cpu-scheduling/multicore-processors.webp" caption="Multicore Processors" />
...
<Fig src="/images/os/ch07-cpu-scheduling/multithreaded-multicore-system.webp" caption="Multithreaded Multicore System" />

<Fig src="/images/os/ch07-cpu-scheduling/os-view-of-multithreaded-multicore-system.webp" caption="OS view of Multithreaded Multicore System" />
...
<Fig src="/images/os/ch07-cpu-scheduling/two-level-threading.webp" caption="Two level Threading" />
...
<Fig src="/images/os/ch07-cpu-scheduling/numa-system.webp" caption="NUMA (Non-Uniform Memory Access) System" />
...
<Fig src="/images/os/ch07-cpu-scheduling/event-latency.webp" caption="Event latency" />
...
<Fig src="/images/os/ch07-cpu-scheduling/interrupt-latency.webp" caption="Interrupt Latency" />

#### Dispatch Latency

我們需要把 Core 上的 Process 轉換成另外一個 Process 來跑，要把資源 release 出來

<Fig src="/images/os/ch07-cpu-scheduling/dispatch-latency.webp" caption="Dispatch Latency" />
...
<Fig src="/images/os/ch07-cpu-scheduling/periodic-process-require-cpu-at-constant-interva.webp" caption="Periodic Process require CPU at constant interval" />
...
<Fig src="/images/os/ch07-cpu-scheduling/example-of-rate-monotonic-scheduling.webp" caption="Example of Rate-Monotonic Scheduling" />
...
<Fig src="/images/os/ch07-cpu-scheduling/counter-example-of-rate-monotonic-scheduling.webp" caption="Counter-example of Rate-Monotonic Scheduling" />
...
<Fig src="/images/os/ch07-cpu-scheduling/example-of-edf-scheduling.webp" caption="Example of EDF Scheduling" />
...
<Fig src="/images/os/ch07-cpu-scheduling/example-of-domain.webp" caption="Example of domain" />
...
<Fig src="/images/os/ch07-cpu-scheduling/windows-scheduling.webp" caption="Windows scheduling" />
...
<Fig src="/images/os/ch07-cpu-scheduling/solaris-scheduling.webp" caption="Solaris scheduling" />

在 Solaris 裡面 Priority 數字越高，代表 Priority 越高

<Fig src="/images/os/ch07-cpu-scheduling/solaris-priority.webp" caption="Solaris Priority" />
...
<Fig src="/images/os/ch07-cpu-scheduling/fcfs-28ms.webp" caption="FCFS：28ms" />
<Fig src="/images/os/ch07-cpu-scheduling/nonpreemptive-sjf-13ms.webp" caption="Nonpreemptive SJF：13ms" />
<Fig src="/images/os/ch07-cpu-scheduling/round-robin-23ms.webp" caption="Round Robin：23ms" />
