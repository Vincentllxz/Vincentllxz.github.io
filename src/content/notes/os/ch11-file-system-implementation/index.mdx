---
title: 'NTU-OS 作業系統 Ch14 File-System Implementation'
description: 'NTU Operating System 作業系統:Ch14 File-System Implementation'
...
<div style='text-align: center;'>
  <img
    src='/images/os/ch11-file-system-implementation/layered-file-systems.webp'
    style='width: 50%;'
  />
  <br />
  <span style='color: grey; font-size: 16px;'>Layered File Systems</span>
</div>
...
<div style='text-align: center;'>
  <img
    src='/images/os/ch11-file-system-implementation/file-open-and-read.webp'
    style='width: 80%;'
  />
  <br />
  <span style='color: grey; font-size: 16px;'>File Open and File Read</span>
</div>
...
<div style='text-align: center;'>
  <img
    src='/images/os/ch11-file-system-implementation/contiguous-allocation.webp'
    style='width: 80%;'
  />
  <br />
  <span style='color: grey; font-size: 16px;'>Contiguous Allocation</span>
</div>
...
<div style='text-align: center;'>
  <img
    src='/images/os/ch11-file-system-implementation/linked-allocation.webp'
    style='width: 70%;'
  />
  <br />
  <span style='color: grey; font-size: 16px;'>Linked Allocation</span>
</div>
...
<div style='text-align: center;'>
  <img
    src='/images/os/ch11-file-system-implementation/file-allocation-table.webp'
    style='width: 70%;'
  />
  <br />
  <span style='color: grey; font-size: 16px;'>File-Allocation Table</span>
</div>
...
<div style='text-align: center;'>
  <img
    src='/images/os/ch11-file-system-implementation/indexed-allocation.webp'
    style='width: 70%;'
  />
  <br />
  <span style='color: grey; font-size: 16px;'>Indexed Allocation</span>
</div>
...
<div style='text-align: center;'>
  <img
    src='/images/os/ch11-file-system-implementation/combined-scheme-unix.webp'
    style='width: 70%;'
  />
  <br />
  <span style='color: grey; font-size: 16px;'>Combined scheme in Unix-based system</span>
</div>
...
<div style='text-align: center;'>
  <img
    src='/images/os/ch11-file-system-implementation/free-space-linked-list.webp'
    style='width: 70%;'
  />
  <br />
  <span style='color: grey; font-size: 16px;'>Linked List method on free-space</span>
</div>
...
<div style='text-align: center;'>
  <img loading="lazy" decoding="async" src='/images/os/ch11-file-system-implementation/double-caching.webp' style='width: 60%;' />
  <br />
  <span style='color: grey; font-size: 16px;'>Double Caching</span>
</div>
...
<div style='text-align: center;'>
  <img
    src='/images/os/ch11-file-system-implementation/unified-buffer-cache.webp'
    style='width: 60%;'
  />
  <br />
  <span style='color: grey; font-size: 16px;'>Unified Buffer Cache</span>
</div>
...
<div style='text-align: center;'>
  <img loading="lazy" decoding="async" src='/images/os/ch11-file-system-implementation/wafl-file-system.webp' style='width: 90%;' />
  <br />
  <span style='color: grey; font-size: 16px;'>WAFL File System</span>
</div>
...
<div style='text-align: center;'>
  <img loading="lazy" decoding="async" src='/images/os/ch11-file-system-implementation/wafl-snapshot.webp' style='width: 100%;' />
  <br />
  <span style='color: grey; font-size: 16px;'>Snapshot of WAFL File System</span>
</div>
