...
<Fig src="/images/os/ch05-main-memory/basic-hardware.webp" />
...
<Fig src="/images/os/ch05-main-memory/address-protection.webp" caption="Address Protection" />
...
<Fig src="/images/os/ch05-main-memory/address-binding.webp" />
...
<Fig src="/images/os/ch05-main-memory/memory-management-unit.webp" />
...
<Fig src="/images/os/ch05-main-memory/memory-protection.webp" caption="Memory Protection" />
...
<Fig src="/images/os/ch05-main-memory/memory-allocation.webp" caption="Memory Allocation" />
...
<Fig src="/images/os/ch05-main-memory/basic-method-2.webp" caption="Basic Method 2" />
...
<Fig src="/images/os/ch05-main-memory/basic-method-1.webp" />

可以是不連續的 Access，Logical 上看 Page 0~3 是連續的，但在 Frame 上看是不連續的

<Fig src="/images/os/ch05-main-memory/basic-method-3.webp" caption="Basic Method 3" />

access `10` 會變成 `60` 也就是 `6*4 + 0 = 24` 是 `e`

<Fig src="/images/os/ch05-main-memory/basic-method-4.webp" caption="Basic Method 4" />
...
<Fig src="/images/os/ch05-main-memory/translation-look-aside-buffer-1.webp" caption="Translation Look-Aside Buffer 1" />
...
<Fig src="/images/os/ch05-main-memory/translation-look-aside-buffer-2.webp" caption="Translation Look-Aside Buffer 2" />
</Aside>
...
<Fig src="/images/os/ch05-main-memory/valid-invalid-bit.webp" caption="Valid-invalid bit" />
...
<Fig src="/images/os/ch05-main-memory/shared-pages.webp" caption="Shared Pages" />
...
<Fig src="/images/os/ch05-main-memory/two-level-paging.webp" caption="Two-Level Paging" />
...
<Fig src="/images/os/ch05-main-memory/hashed-page-tables.webp" caption="Hashed Page Tables" />
...
<Fig src="/images/os/ch05-main-memory/inverted-page-tables.webp" caption="Inverted Page Tables" />
...
<Fig src="/images/os/ch05-main-memory/swapping.webp" caption="Swapping" />
...
<Fig src="/images/os/ch05-main-memory/swapping-with-paging.webp" caption="Swapping with Paging" />
...
<Fig src="/images/os/ch05-main-memory/armv8-architecture.webp" caption="ARMv8 Architecture" />
