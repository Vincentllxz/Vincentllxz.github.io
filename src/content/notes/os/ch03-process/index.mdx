...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch03-process/memory-layout-1.webp" style="width: 50%;" />
</div>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch03-process/memory-layout-2.webp" style="width: 100%;" />
  <br />
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch03-process/memory-layout-3.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Memory Layout 3
  </span>
...
- 不把 dynamic allocate 的 memory 存在 Stack 是防止 stack close 後還需要取用，不能被 close 掉
</Aside>


### Process State
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch03-process/process-state.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Process State
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch03-process/process-control-block.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch03-process/scheduling-queue.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Scheduling Queue
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch03-process/queuing-diagram.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Queuing Diagram
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch03-process/context-switch.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Context Switch
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch03-process/process-creation.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Process Creation
  </span>
...
上面的程式執行大概是這樣
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch03-process/process-creation-using-unix-fork.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Process Creation Using UNIX fork
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch03-process/interprocess-communication.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Interprocess Communication
  </span>
...
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch03-process/windows.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Windows
  </span>
...
- **Binding**：對 port 的定義
    ...
    - Dynamic
<div style="text-align: center;">
  <img loading="lazy" decoding="async" src="/images/os/ch03-process/remote-procedure-calls.webp" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Remote Procedure Calls
  </span>
