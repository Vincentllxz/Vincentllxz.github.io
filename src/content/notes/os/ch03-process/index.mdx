...
### Memory Layout
<Fig src="/images/os/ch03-process/memory-layout-1.webp" />
...
<Fig src="/images/os/ch03-process/memory-layout-2.webp" caption="Memory Layout 2" />
...
<Fig src="/images/os/ch03-process/memory-layout-3.webp" caption="Memory Layout 3" />
...
### Process State
<Fig src="/images/os/ch03-process/process-state.webp" caption="Process State" />
...
<Fig src="/images/os/ch03-process/process-control-block.webp" caption="Process Control Block" />
...
<Fig src="/images/os/ch03-process/scheduling-queue.webp" caption="Scheduling Queue" />
...
<Fig src="/images/os/ch03-process/queuing-diagram.webp" caption="Queuing Diagram" />
...
<Fig src="/images/os/ch03-process/context-switch.webp" caption="Context Switch" />
...
<Fig src="/images/os/ch03-process/process-creation.webp" caption="Process Creation" />
...
上面的程式執行大概是這樣
<Fig src="/images/os/ch03-process/process-creation-using-unix-fork.webp" caption="Process Creation Using UNIX fork" />
...
<Fig src="/images/os/ch03-process/interprocess-communication.webp" caption="Interprocess Communication" />
...
<Fig src="/images/os/ch03-process/windows.webp" caption="Windows" />
...
- **Binding**：對 port 的定義
    - Predetermined
    - Dynamic
<Fig src="/images/os/ch03-process/remote-procedure-calls.webp" caption="Remote Procedure Calls" />