...
![Memory Layout 2](/images/os/ch03-process/memory-layout-2.png)
...
![Memory Layout 3](/images/os/ch03-process/memory-layout-3.png)
...
### Process State
![Process State](/images/os/ch03-process/process-state.png)
...
![Process Control Block](/images/os/ch03-process/process-control-block.png)
...
![Scheduling Queue](/images/os/ch03-process/scheduling-queue.png)
...
![Queuing Diagram](/images/os/ch03-process/queuing-diagram.png)
...
![Context Switch](/images/os/ch03-process/context-switch.png)
...
![Process Creation](/images/os/ch03-process/process-creation.png)
...
上面的程式執行大概是這樣
![Process Creation Using UNIX fork](/images/os/ch03-process/process-creation-using-unix-fork.png)
...
![Interprocess Communication](/images/os/ch03-process/interprocess-communication.png)
...
![Windows](/images/os/ch03-process/windows.png)
...
- **Binding**：對 port 的定義
    - Predetermined
    - Dynamic
![Remote Procedure Calls](/images/os/ch03-process/remote-procedure-calls.png)