---
title: "NTU-OS 作業系統 Ch10 File-System Interface"
description: "NTU Operating System 作業系統:Ch10 File-System Interface"
...
<div style="text-align: center;">
  <img src="/images/os/ch10-file-system-interface/file-types.png" style="width: 80%;" />
  <br />
...
<div style="text-align: center;">
  <img src="/images/os/ch10-file-system-interface/sequential-access.png" style="width: 70%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Sequential Access
  </span>
...
這種 file 裡面都會有 fix length 的 **locgical address**，可以用這個東西做參考
...
有很多建立在 Direct Access 之上的方法，通常都跟 **inde** 有關，存一個 index table 來做存取，但如果一個 index table 太大也可能會需要 multilevel

- IBM indexed sequential-access method (ISAM)
- OpenVMS index and relative files

<div style="text-align: center;">
  <img src="/images/os/ch10-file-system-interface/openvms.png" style="width: 70%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     OpenVMS
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch10-file-system-interface/single-level-directory.png" style="width: 70%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Single-Level Directory
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch10-file-system-interface/two-level-directory.png" style="width: 70%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Two-Level Directory
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch10-file-system-interface/tree-structured-directories.png" style="width: 60%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Tree-Structured Directories
  </span>
...
在這種 framwork 底下，delete directory 是一件值得思考的事情，有些系統會 not delete unless is empty，有些則會 delete 所有底下的 file
...
<div style="text-align: center;">
  <img src="/images/os/ch10-file-system-interface/acyclic-graph-directories.png" style="width: 60%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Acyclic-Graph Directories
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch10-file-system-interface/general-graph-directory.png" style="width: 60%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     General Graph Directory
  </span>
...
我們可以透過這樣的機制，把 data 先寫到 memory 裡面，再寫回各自的 file 裡面，就可以做到 Concurrecy

這樣的方法也支持 copy-on-write，也就是先 share 一個 read only 的 file，當某個 process 想改的時候，再做 copy 就好

<div style="text-align: center;">
  <img src="/images/os/ch10-file-system-interface/copy-on-write.png" style="width: 80%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Copy-on-Write
  </span>
...
因為 memory-mapping file 本身就是就是一個 memory，只要兩個 process share 那個 file 就好了

<div style="text-align: center;">
  <img src="/images/os/ch10-file-system-interface/share-memory.png" style="width: 70%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Share memory
  </span>
