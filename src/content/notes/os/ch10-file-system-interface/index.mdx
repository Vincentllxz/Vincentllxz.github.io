...
<Fig src="/images/os/ch10-file-system-interface/file-types.webp" caption="Table of File types" />
...
<Fig src="/images/os/ch10-file-system-interface/sequential-access.webp" caption="Sequential Access" />
...
<Fig src="/images/os/ch10-file-system-interface/openvms.webp" caption="OpenVMS" />
...
<Fig src="/images/os/ch10-file-system-interface/single-level-directory.webp" caption="Single-Level Directory" />
...
<Fig src="/images/os/ch10-file-system-interface/two-level-directory.webp" caption="Two-Level Directory" />
...
<Fig src="/images/os/ch10-file-system-interface/tree-structured-directories.webp" caption="Tree-Structured Directories" />
...
<Fig src="/images/os/ch10-file-system-interface/acyclic-graph-directories.webp" caption="Acyclic-Graph Directories" />
...
<Fig src="/images/os/ch10-file-system-interface/general-graph-directory.webp" caption="General Graph Directory" />
...
<Fig src="/images/os/ch10-file-system-interface/copy-on-write.webp" caption="Copy-on-Write" />

因為 memory-mapping file 本身就是一個 memory，只要兩個 process share 那個 file 就好了

<Fig src="/images/os/ch10-file-system-interface/share-memory.webp" caption="Share memory" />
