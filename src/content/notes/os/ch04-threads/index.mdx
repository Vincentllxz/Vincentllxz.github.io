...
![Overview](/images/os/ch04-threads/overview.png)
...
![Multicore Programming 1](/images/os/ch04-threads/multicore-programming-1.png)

下面這張則是同時有 Concurrency 跟 Parallelism
![Multicore Programming 2](/images/os/ch04-threads/multicore-programming-2.png =65%x)
...
![Parallelism 1](/images/os/ch04-threads/parallelism-1.png)

- **Task parallelism**
共用一個 data，但四個 core 在做不同的 task
![Parallelism 2](/images/os/ch04-threads/parallelism-2.png)
...
![Many-to-One Model](/images/os/ch04-threads/many-to-one-model.png)
...
![One-to-One Model](/images/os/ch04-threads/one-to-one-model.png)
...
![Many-to-Many Model 2](/images/os/ch04-threads/many-to-many-model-2.png)
...
![Fork join 1](/images/os/ch04-threads/fork-join-1.png)
...
```
![Fork join 2](/images/os/ch04-threads/fork-join-2.png)
- 一直切一直切一直切
```java
...
![Fork join 3](/images/os/ch04-threads/fork-join-3.png)
</Aside>
