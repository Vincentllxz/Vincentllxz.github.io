...
<Fig src="/images/os/ch04-threads/overview.webp" caption="Overview" />
...
<Fig src="/images/os/ch04-threads/multicore-programming-1.webp" caption="Multicore Programming 1" />

下面這張則是同時有 Concurrency 跟 Parallelism
<Fig src="/images/os/ch04-threads/multicore-programming-2.webp" caption="Multicore Programming 2" />
...
<Fig src="/images/os/ch04-threads/parallelism-1.webp" caption="Parallelism 1" />

- **Task parallelism**
共用一個 data，但四個 core 在做不同的 task
<Fig src="/images/os/ch04-threads/parallelism-2.webp" caption="Parallelism 2" />
...
<Fig src="/images/os/ch04-threads/amdahl-s-law.webp" />
...
<Fig src="/images/os/ch04-threads/many-to-one-model.webp" caption="Many-to-One Model" />
...
<Fig src="/images/os/ch04-threads/one-to-one-model.webp" caption="One-to-One Model" />
...
<Fig src="/images/os/ch04-threads/many-to-many-model-2.webp" caption="Many-to-Many Model 2" />

Two-level model 也是一種 Many-to-Many Model 的變形

<Fig src="/images/os/ch04-threads/many-to-many-model-1.webp" />
...
<Fig src="/images/os/ch04-threads/fork-join-1.webp" caption="Fork join 1" />
...
```
<Fig src="/images/os/ch04-threads/fork-join-2.webp" caption="Fork join 2" />
- 一直切一直切一直切
```java
...
<Fig src="/images/os/ch04-threads/fork-join-3.webp" caption="Fork join 3" />
</Aside>
...
<Fig src="/images/os/ch04-threads/lightweight-process.webp" />
