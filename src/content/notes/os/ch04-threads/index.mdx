...
<div style="text-align: center;">
  <img src="/images/os/ch04-threads/overview.png" style="width: 100%;" />
  <br />
...
<div style="text-align: center;">
  <img src="/images/os/ch04-threads/multicore-programming-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch04-threads/multicore-programming-2.png" style="width: 65%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch04-threads/parallelism-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Parallelism 1
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch04-threads/parallelism-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Parallelism 2
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch04-threads/amdahl-s-law.png" style="width: 70%;" />
</div>
...
<div style="text-align: center;">
  <img src="/images/os/ch04-threads/many-to-one-model.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Many-to-One Model
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch04-threads/one-to-one-model.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     One-to-One Model
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch04-threads/many-to-many-model-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
...
<div style="text-align: center;">
  <img src="/images/os/ch04-threads/many-to-many-model-1.png" style="width: 70%;" />
</div>
...
> 參考 [System Programming 系統程式設計 筆記](/1-_CzGphTiCrzZWiBODFIQ)
...
<div style="text-align: center;">
  <img src="/images/os/ch04-threads/fork-join-1.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Fork join 1
  </span>
...
```
<div style="text-align: center;">
  <img src="/images/os/ch04-threads/fork-join-2.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Fork join 2
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch04-threads/fork-join-3.png" style="width: 100%;" />
  <br />
  <span style="color: grey; font-size: 16px;">
     Fork join 3
  </span>
...
<div style="text-align: center;">
  <img src="/images/os/ch04-threads/lightweight-process.png" style="width: 40%;" />
</div>
